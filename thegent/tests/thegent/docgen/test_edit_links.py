...
def test_generate_edit_url(repo_root):
    ...
    generator = EditLinkGenerator(repo_url="https://github.com/user/repo", base_dir=repo_root)
...
def test_generate_edit_url_custom_branch(repo_root):
    ...
    generator = EditLinkGenerator(repo_url="https://github.com/user/repo", base_dir=repo_root, branch="develop")
