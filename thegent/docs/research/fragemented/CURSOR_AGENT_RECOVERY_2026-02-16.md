...
**Context:** User reported multiple crashes. Cursor stores chat history in app state. This file is for manually pasting/merging research and plans from those sessions.

---

## How to Recover

1. Open Cursor → Chat history (or Composer history)
2. Filter by date: 2026-02-16
3. For each conversation, copy:
   - Research findings
   - Plans discussed
   - Decisions made
   - Fixes applied
   - Open questions
4. Paste below under dated sections, or merge into `thegent/docs/research/CONVERSATION_DUMP_2026-02-16.md`
