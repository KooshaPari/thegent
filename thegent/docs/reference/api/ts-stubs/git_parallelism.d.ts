// Auto-generated TypeScript declarations for git_parallelism
// Source: generate-api-docs.py

export declare class GitParallelismManager {
  constructor(project_root: string, agent_id: string);
...
export declare function harness_git_status_view(agent_id: string): void;
