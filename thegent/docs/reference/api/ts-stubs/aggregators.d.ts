// Auto-generated TypeScript declarations for aggregators
...
export declare class CostTracker {
  ...
  record_cost(session_id: string, amount: number): void;
...
export declare function record_cost(session_id: string, amount: number): void;
