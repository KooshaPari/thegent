...
```python
run_impl(agent: Any, prompt: str, cd: Any, mode: str, timeout: Any, full: bool, live: bool, model: Any, provider: Any, run_id: Any, owner: Any, include_contract: bool, route_contract: Any, route_request: Any, lane: str, confidence: Any, override_reason: Any, contract_version: Any, domain: Any, idempotency_token: Any, correlation_id: Any, speculative: bool, arbitration: Any, routing: Any, enable_search: bool, debug: bool, task_id: Any, shadow: bool, lock: Any, remote: Any, config_provider: ConfigProvider | None)
```
