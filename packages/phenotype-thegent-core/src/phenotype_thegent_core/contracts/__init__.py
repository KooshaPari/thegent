...
def _lazy_import_adapters():
    ...
    if _adapters_module is None:
        import phenotype_thegent_core.contracts.adapters as _adapters_module
...
from phenotype_thegent_core.contracts.csm import (
    CanonicalStructuredMessage,
    CSMPhase,
    CSMStatus,
)
from phenotype_thegent_core.contracts.events import ChunkEvent, EvidenceEvent, PolicyEvent
from phenotype_thegent_core.contracts.registry import (
