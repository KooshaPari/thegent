...
phenotype_thegent_cli.cli.commands.impl.  Now agents depend on this abstract protocol;
...
class RunnerPort(Protocol):
    ...
    The concrete implementation is phenotype_thegent_cli.cli.commands.impl.run_impl
    (or a compatible callable).  Agent code must not import from phenotype_thegent_cli
...
class DagStatusPort(Protocol):
    ...
    Mirrors dag_status_impl from phenotype_thegent_cli without importing it.
    """
