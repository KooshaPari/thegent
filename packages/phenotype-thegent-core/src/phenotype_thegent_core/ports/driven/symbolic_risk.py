...
phenotype_thegent_audit.verification.symbolic.  Now core defines this abstract
...
class RiskPath:
    ...
    This mirrors phenotype_thegent_audit.verification.symbolic.RiskPath so that
    thegent-core does not need to import from phenotype_thegent_audit.
    """
