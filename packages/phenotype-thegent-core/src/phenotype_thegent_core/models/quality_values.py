...
def get_model_quality_index(
    ...
    """
    from phenotype_thegent_core.models.catalog import ModelCatalog, normalize_model_id
...
def get_model_provider_quality_indices(
    ...
    from phenotype_thegent_core.models.cost_values import _iter_catalog_routes
