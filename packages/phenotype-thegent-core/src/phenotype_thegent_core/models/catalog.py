...
from phenotype_thegent_core.utils.provider_names import normalize_provider_name
from phenotype_thegent_core.infra import get_cache
...
def resolve_route(
    ...
    if policy == "pareto":
        try:
            from phenotype_thegent_core.utils.routing_impl.pareto_router import (
                Offer,
                _get_quality,
