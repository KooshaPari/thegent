...
phenotype_thegent_audit.verification.symbolic, creating a Core ↔ Audit cycle.
It now accepts any object satisfying the SymbolicRiskPort protocol defined in
phenotype_thegent_core.ports.driven.symbolic_risk.  The concrete SymbolicRiskExplorer
...
from phenotype_thegent_core.models.catalog import ModelCatalog, RoutePolicy
from phenotype_thegent_core.ports.driven.symbolic_risk import NullSymbolicRiskPort, SymbolicRiskPort
...
class HybridRouter:
    ...
    def __init__(self, dag: Any, symbolic_explorer: SymbolicRiskPort | None = None) -> None:
        ...
        if symbolic_explorer is None:
            ...
            _log.debug(
                ...
                "Pass a concrete SymbolicRiskExplorer from phenotype_thegent_audit for live risk assessment."
            )
    ...
    def route_safely(self, task_type: str, prompt: str, start_node: str) -> tuple[str, str]:
        ...
        from phenotype_thegent_core.models.catalog import resolve_route
