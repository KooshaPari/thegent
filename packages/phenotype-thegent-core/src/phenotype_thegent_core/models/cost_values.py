...
phenotype_thegent_core.ports.driven.proxy_metrics.  A module-level NullProxyMetricsPort
...
from phenotype_thegent_core.ports.driven.proxy_metrics import NullProxyMetricsPort, ProxyMetricsPort
...
# from phenotype_thegent_agents via set_proxy_metrics_port().
...
def _get_proxy_metrics_port() -> ProxyMetricsPort:
    ...
    if isinstance(_proxy_metrics_port, NullProxyMetricsPort):
        ...
        try:
            from phenotype_thegent_agents.agents.cliproxy_manager import (  # type: ignore[import-not-found]
...
def _iter_catalog_routes() -> list[tuple[str, list]]:
    ...
    from phenotype_thegent_core.models.catalog import _get_catalog, _scraped_to_routes
