...
def scrape_all(settings: ThegentSettings | None = None) -> dict[str, list[str]]:
    ...
    try:
        ...
        try:
            ...
            from phenotype_thegent_core.models.catalog import filter_models_for_provider
...
def scrape_proxy(settings: ThegentSettings | None = None) -> dict[str, list[str]]:
    ...
    try:
        from phenotype_thegent_core.models.cost_values import _get_proxy_metrics_port
...
def scrape_ante() -> list[str]:
    ...
    from phenotype_thegent_core.models.ante_scraper import scrape_ante_models
