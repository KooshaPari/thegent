...
if TYPE_CHECKING:
    ...
    from phenotype_thegent_routing.cost.aggregator_controller import CostController
    from phenotype_thegent_audit.governance.analyzer import HealthAnalyzer
    ...
    from phenotype_thegent_planning.planning.remediation_planner import RemediationPlanner
...
class AgilePlusLoop:
    ...
    def _init_components(self) -> None:
        ...
        from phenotype_thegent_audit.governance.backlog import BacklogManager
        from phenotype_thegent_audit.governance.evidence_ledger import EvidenceLedger
        from phenotype_thegent_audit.governance.health_score import HealthScoreComputer
        from phenotype_thegent_audit.governance.scanner import CodebaseScanner
        from phenotype_thegent_planning.planning.remediation_planner import RemediationPlanner
    ...
    def _run_deployment(self, plan: Any, pre_scan: Any) -> Any:
        ...
        from phenotype_thegent_audit.governance.agent_deployer import AgentDeployer
    ...
    def _run_verification(self, deployment_result: Any, pre_scan: Any) -> int:
        ...
        from phenotype_thegent_audit.governance.verification_gate import VerificationGate
