...
from phenotype_thegent_audit.economy.reputation import ReputationManager
from phenotype_thegent_audit.governance.agent_hierarchy import AgentHierarchyManager
from phenotype_thegent_audit.governance.backlog import BacklogManager
from phenotype_thegent_audit.governance.constitution import ConstitutionManager
from phenotype_thegent_audit.governance.evidence_ledger import EvidenceLedger
from phenotype_thegent_audit.governance.overrides import OverrideManager
from phenotype_thegent_audit.governance.teammates import TeammateManager
from phenotype_thegent_core.infra.process_registry import ProcessRegistry
from phenotype_thegent_core.infra.subprocess_manager import SubprocessManager
...
from phenotype_thegent_core.memory.manager import MemoryManager
from phenotype_thegent_observability.observability.analytics import AnalyticsIntegration
from phenotype_thegent_observability.observability.egress import EgressEvent, SIEMEgress
from phenotype_thegent_execution.orchestration.execution.lanes import Lane, LaneModel
from phenotype_thegent_execution.orchestration.execution.worker_pool import PersistentWorkerPool
from phenotype_thegent_execution.orchestration.resilience.deferral import DeferralManager
from phenotype_thegent_execution.orchestration.resource.load_based_limits import (
    compute_dynamic_limit,
    sample_resources,
)
from phenotype_thegent_execution.orchestration.state.session_watcher import SessionEventWatcher
from phenotype_thegent_planning.planning.work_stream import WorkStreamManager
from phenotype_thegent_planning.planning.workstream_db import WorkstreamDB
from phenotype_thegent_core.utils.routing_impl.task_router import TaskRouter
from phenotype_thegent_audit.security.rbac import Permission, RBACManager, Role
from phenotype_thegent_sync.sync import SyncOrchestrator, SyncRegistry
from phenotype_thegent_agents.team.coordination import TeamCoordinator
from phenotype_thegent_cli.ux.alerts import AlertFatigueController, InterruptionKind
...
class AutoLaunchSystem:
    ...
    def sync_database(self) -> None:
        ...
        try:
            from phenotype_thegent_cli.cli.commands.impl import _parse_work_stream_md
    ...
    async def launch_batch(self, items: list[dict[str, Any]], role: Role = Role.OPERATOR) -> None:
        ...
        for item in sorted_items:
            ...
            # Emit SIEM event
            from phenotype_thegent_observability.observability.egress import EgressEvent
    ...
    async def _launch_item(self, item: dict[str, Any], lane: str, model: str, estimated_cost: float) -> None:
        ...
        from phenotype_thegent_cli.cli.commands.impl import work_stream_claim_impl
        ...
        from phenotype_thegent_cli.cli.commands.impl import bg_impl
