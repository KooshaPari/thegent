...
from phenotype_thegent_planning.planning.models_meta import MODEL_METADATA, ModelMetadata
...
class ObjectiveSelector:
    ...
    def _calculate_score(self, meta: ModelMetadata, model_id: str | None = None) -> float:
        ...
        if model_id:
            try:
                from phenotype_thegent_core.models.quality_values import get_model_quality_index
                from phenotype_thegent_core.models.speed_values import get_model_best_speed_index
