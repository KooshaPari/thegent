...
class DirectAgentRunner(AgentRunner):
    ...
    def run(
        ...
        *,
        ...
        if audio_paths:
            from thegent_agents.audio_inputs import inject_transcript_into_prompt, load_transcripts
        ...
        with instrument_genai_call(
            ...
            if self._uses_stdin and self.agent_name == "claude" and image_paths:
                from thegent_agents.image_inputs import build_claude_stdin_with_images
