...
from phenotype_thegent_core.resilience import transient_retry
...
class GitHubBoardAdapter:
    ...
    def sync(self, board_id: str, work_stream_items: list[dict[str, str]]) -> dict[str, Any]:
        from phenotype_thegent_sync.integrations.gh_project_sync import GHProjectConfig, sync_to_github
    ...
    def fetch_remote_status(
        ...
        from phenotype_thegent_sync.integrations.gh_project_sync import GHProjectConfig, sync_from_github
...
class LinearBoardAdapter:
    ...
    def fetch_remote_status(
        ...
        from phenotype_thegent_sync.integrations.linear_graphql import LinearGraphQLConfig, sync_from_linear
