...
def memory_garden(
    ...
    # @trace WL-060
    """
    from thegent_agents.gardener import GardenerAgent
...
def memory_snapshot_list(
    ...
    from thegent_cli.commands.team_cmds import snapshot_list_cmd
...
def memory_snapshot_index(
    ...
    from thegent_cli.commands.team_cmds import snapshot_index_cmd
...
def memory_snapshot_export(
    ...
    from thegent_cli.commands.team_cmds import snapshot_export_cmd
...
def memory_snapshot_prune(
    ...
    from thegent_cli.commands.team_cmds import snapshot_prune_cmd
...
def memory_snapshot_meta(
    ...
    from thegent_cli.commands.team_cmds import snapshot_meta_cmd
...
def memory_snapshot_daily_index(
    ...
    from thegent_cli.commands.team_cmds import snapshot_daily_index_cmd
...
def memory_snapshot_daily_export(
    ...
    from thegent_cli.commands.team_cmds import snapshot_daily_export_cmd
...
def memory_snapshot_daily_totals(
    ...
    from thegent_cli.commands.team_cmds import snapshot_daily_totals_cmd
...
def memory_dump_index(
    ...
    from thegent_cli.commands.team_cmds import dump_index_cmd
...
def memory_dump_latest(
    ...
    from thegent_cli.commands.team_cmds import dump_latest_cmd
...
def memory_dump_categories(
    ...
    from thegent_cli.commands.team_cmds import dump_categories_cmd
