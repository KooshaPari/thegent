...
def browser_install(
    ...
    from thegent_cli.commands.browser import browser_install_cmd
...
def browser_doctor() -> None:
    from thegent_cli.commands.browser import browser_doctor_cmd
...
def browser_launch(
    ...
    from thegent_cli.commands.browser import browser_launch_cmd
...
def journey_add(
    ...
    from thegent_cli.commands.browser import browser_journey_add_cmd
...
def journey_list() -> None:
    from thegent_cli.commands.browser import browser_journey_list_cmd
...
def journey_open(
    ...
    from thegent_cli.commands.browser import browser_journey_open_cmd
