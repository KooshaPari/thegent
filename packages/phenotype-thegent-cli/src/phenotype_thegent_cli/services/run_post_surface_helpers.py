...
from phenotype_thegent_agents.agents import get_fallback_agents, list_agent_names
from phenotype_thegent_agents.registry import AGENT_LABELS
...
def list_models_impl(
    *,
    ...
    if include_contract:
        from phenotype_thegent_core.models import ModelCatalog
    ...
    if by_model:
        from phenotype_thegent_core.models import ModelCatalog
        from phenotype_thegent_core.models.scrapers import get_scraped_catalog
...
def harness_interact_impl(
    *,
    ...
    from phenotype_thegent_agents.unified_session_index import HarnessActionError, HarnessTUIMapper, HarnessType
...
def harness_list_actions_impl() -> dict[str, Any]:
    ...
    from phenotype_thegent_agents.unified_session_index import HarnessTUIMapper
...
def harness_register_host_impl(
    *,
    ...
    from phenotype_thegent_agents.unified_session_index import HarnessTUIMapper, HarnessType
