...
def spawn_next_impl(
    ...
    from phenotype_thegent_cli.commands.impl import _default_owner_tag, _resolve_cwd, bg_impl
...
def incorporate_impl(cd: Path | None = None, dry_run: bool = False) -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.commands.impl import _resolve_cwd
    from phenotype_thegent_execution.task.sync import WorkStreamSync
...
def _validate_task_and_record_errors(tf: Path, validation_errors: list[dict[str, Any]]) -> None:
    ...
    from phenotype_thegent_execution.task.validator import validate_task_file
