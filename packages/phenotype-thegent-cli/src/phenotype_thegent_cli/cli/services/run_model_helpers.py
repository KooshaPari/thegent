...
def validate_explicit_ollama_provider(*, provider: str | None, model: str | None) -> str | None:
    ...
    from phenotype_thegent_core.utils.routing_impl.provider_types import normalize_provider_name

    if normalize_provider_name(provider) != "ollama":
        return None

    from phenotype_thegent_core.models import normalize_model_id
    from phenotype_thegent_core.utils.routing_impl.ollama_provider import (
