...
def harness_interact_impl(
    *,
    ...
    from phenotype_thegent_agents.agents.unified_session_index import HarnessActionError, HarnessTUIMapper, HarnessType
...
def harness_list_actions_impl() -> dict[str, Any]:
    ...
    from phenotype_thegent_agents.agents.unified_session_index import HarnessTUIMapper
...
def harness_register_host_impl(
    *,
    ...
    from phenotype_thegent_agents.agents.unified_session_index import HarnessTUIMapper, HarnessType
