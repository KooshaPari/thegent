...
if TYPE_CHECKING:
    from phenotype_thegent_audit.govern.vetter.models import VetterCheckResult, VetterPolicy
...
def _load_vetter_components() -> tuple[
    ...
    from phenotype_thegent_audit.govern.vetter.models import VetterPolicy
