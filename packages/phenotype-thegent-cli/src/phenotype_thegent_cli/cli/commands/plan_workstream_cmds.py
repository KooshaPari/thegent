...
from phenotype_thegent_cli.cli.commands.plan_output_helpers import (
...
from phenotype_thegent_cli.cli.commands.run_cmds import bg_cmd
from phenotype_thegent_cli.cli.commands.session_cmds import history_cmd
...
def plan_incorporate_cmd(cd: Path | None = None, dry_run: bool = False) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.work_stream_impl import incorporate_impl
...
def plan_claim_cmd(item_id: str, agent_id: str | None = None, cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.work_stream_impl import work_stream_claim_impl
...
def plan_complete_cmd(item_id: str, agent_id: str | None = None, cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.work_stream_impl import work_stream_complete_impl
    from phenotype_thegent_agents.discovery import get_current_agent_id
...
def plan_wait_next_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.work_stream_impl import wait_next_impl
...
def plan_do_next_cmd(cd: Path | None = None, limit: int = 5, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.work_stream_impl import do_next_impl
...
def plan_analyze_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import plan_analyze_impl
