...
def verify_context_impl(files: list[str], cd: Path | None = None) -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.cli.commands.impl import _resolve_cwd
    from phenotype_thegent_agents.coordination.file_coordination import OCCManager
...
def concurrency_show_impl() -> None:
    ...
    from phenotype_thegent_execution.orchestration.resource.load_based_limits import compute_dynamic_limit, sample_resources
...
def monitor_impl(interval: float = 2.0) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import do_next_impl, ps_impl as _ps_impl
...
def isolation_check_impl(mode: str = "sub-user") -> None:
    ...
    from phenotype_thegent_core.infra.worker_node import HAS_SHM
    ...
    from phenotype_thegent_execution.isolation.vfs import VfsAdapter
...
def orchestrate_plan_impl(
    ...
    *,
    ...
    from phenotype_thegent_agents.agents.plangent import LLMPlangentPlanner
...
def orchestrate_run_impl(
    ...
    *,
    ...
    from phenotype_thegent_agents.agents.plangent import LLMPlangentPlanner, PlangentExecutor
    from phenotype_thegent_execution.orchestration.event_queue import SubAgentEventQueue
    from phenotype_thegent_execution.orchestration.result_aggregator import ResultAggregator
    from phenotype_thegent_execution.orchestration.sub_agent_dispatcher import CapabilityIndex, SubAgentDispatcher
    ...
    from phenotype_thegent_cli.cli.commands.impl import run_impl
    ...
    from phenotype_thegent_execution.orchestration.protocol import SubAgentResult, SubAgentStatus
