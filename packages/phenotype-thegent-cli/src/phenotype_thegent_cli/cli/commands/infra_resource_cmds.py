...
from phenotype_thegent_cli.cli.commands.infra_env_helpers import resolve_env_file, rewrite_max_concurrency_lines
...
def usage_cmd(format: str | None = None, include_cost: bool = True) -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_agents.agents.cliproxy_manager import fetch_provider_metrics
    from phenotype_thegent_cli.cli.commands.infra_usage_helpers import build_provider_usage_table
