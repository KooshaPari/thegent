...
def get_server_meta_impl() -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.cli.commands.observability_health_impl import (  # pyright: ignore[reportMissingImports]
        HEALTH_PAYLOAD_SCHEMA_VERSION,
        HEALTH_PAYLOAD_TYPES,
    )
    from phenotype_thegent_cli.cli.commands.observability_trends_impl import (  # pyright: ignore[reportMissingImports]
        OBSERVE_SUMMARY_PAYLOAD_TYPES,
        OBSERVE_SUMMARY_SCHEMA_VERSION,
    )

    from phenotype_thegent_cli.cli.commands.governance_policy_health_cmds import HEALTH_POLICY_PROFILES  # pyright: ignore[reportMissingImports]
...
def review_impl(
    ...
    from phenotype_thegent_agents.agents.review_output import validate_review_output
...
def sitback_dashboard_impl(profile: str = "medium") -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.cli.commands.session_ops_list_impl import ps_impl
