...
def list_droids_impl(cd: Any = None) -> list[str]:
    from phenotype_thegent_cli.cli.commands.impl import _resolve_cwd, _resolve_droids_dir
    from phenotype_thegent_agents.agents import list_droid_names
...
def plan_analyze_impl(
    ...
    from phenotype_thegent_cli.cli.commands.impl import _resolve_cwd, _parse_dag_full
    from phenotype_thegent_cli.cli.services import run_post_surface_helpers
...
def retry_impl(
    ...
    from phenotype_thegent_agents.agents import get_fallback_agents
    from phenotype_thegent_core.config import ThegentSettings
    from phenotype_thegent_execution.execution import RunRegistry
    from phenotype_thegent_cli.cli.services import run_post_surface_helpers
    from phenotype_thegent_cli.cli.commands.impl_core import bg_impl
