...
from phenotype_thegent_cli.cli.commands.model_cmds_list import (
    _assert_str,
    _run_cliproxyctl_machine_command,
)
from phenotype_thegent_cli.cli.commands.model_cmds_setup_helpers import (
    build_provider_list,
    configure_providers,
    set_env_line,
)
...
def setup_cmd(
    ...
    from phenotype_thegent_agents.agents.cliproxy_manager import (
        _LOGIN_FLAGS,
    ...
    if full:
        ...
        try:
            from phenotype_thegent_protocols.mcp.manage import service_install, service_start
    ...
    try:
        from phenotype_thegent_agents.agents.cliproxy_manager import _ensure_config
...
def rules_sync_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import rules_sync_impl
