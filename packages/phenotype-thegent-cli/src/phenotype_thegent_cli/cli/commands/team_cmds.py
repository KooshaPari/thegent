...
from phenotype_thegent_cli.cli.commands._cli_shared import console
...
from phenotype_thegent_cli.cli.commands.team_analysis_cmds import (
    explain_cmd,
    fallbacks_cmd,
)
from phenotype_thegent_cli.cli.commands.team_handoff_cmds import (
    handoff_cmd,
    handoff_confirm_cmd,
    handoff_list_cmd,
    handoff_show_cmd,
)
from phenotype_thegent_cli.cli.commands.team_monitoring_cmds import (
    dlq_list_cmd,
    drift_monitor_cmd,
    roadmap_cmd,
    self_heal_tests_cmd,
...
from phenotype_thegent_cli.cli.commands.team_summary_cmds import (
    summary_cmd,
...
def queue_list_cmd(watch: bool = False) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.queue_commands import queue_list_cmd as _queue_list_cmd_impl
...
def team_create_cmd(name: str, leader: str | None = None, teammates: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.team_commands import team_create_cmd as _team_create_cmd_impl
...
def team_task_add_cmd(team_id: str, title: str, description: str) -> None:
    """Backward-compatible wrapper for extracted team command group."""
    from phenotype_thegent_cli.cli.commands.team_commands import team_task_add_cmd as _team_task_add_cmd_impl
...
def team_task_list_cmd(team_id: str) -> None:
    """Backward-compatible wrapper for extracted team command group."""
    from phenotype_thegent_cli.cli.commands.team_commands import team_task_list_cmd as _team_task_list_cmd_impl
...
def recover_status_cmd() -> None:
    ...
    from phenotype_thegent_cli.cli.commands.recovery_commands import recover_status_cmd as _recover_status_cmd_impl
...
def project_register_cmd(path, name: str | None = None) -> None:  # noqa: ANN001
    ...
    from phenotype_thegent_cli.cli.commands.project_commands import project_register_cmd as _project_register_cmd_impl
...
def project_list_cmd(
    ...
    """Backward-compatible wrapper for extracted project command group."""
    from phenotype_thegent_cli.cli.commands.project_commands import project_list_cmd as _project_list_cmd_impl
