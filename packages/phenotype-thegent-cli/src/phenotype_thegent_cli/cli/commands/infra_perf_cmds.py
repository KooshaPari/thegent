...
def forensics_snapshot_cmd(run_id: str | None = None, phase: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.recovery_commands import forensics_snapshot_cmd as _forensics_snapshot_cmd_impl
...
def monitor_cmd(interval: float = 2.0) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import monitor_impl
...
def operations_cmd(
    ...
    from phenotype_thegent_cli.cli.commands._cli_shared import console
    from phenotype_thegent_cli.cli.commands.operations_commands import operations_cmd as _operations_cmd_impl
