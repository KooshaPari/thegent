...
from phenotype_thegent_cli.cli.commands import _cli_shared
...
def escalate_add_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import escalate_add_impl
...
def escalate_list_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import escalate_list_impl
...
def sweep_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import sweep_impl
...
def escalate_approve_cmd(run_id: str | None = None) -> None:
    ...
    rid = _resolve_run_id(run_id)
    from phenotype_thegent_cli.cli.commands.impl import escalate_approve_impl
...
def govern_list_pending_cmd(format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import govern_list_pending_impl
    from phenotype_thegent_audit.governance.diff_renderer import DiffPayload, DiffRenderer
