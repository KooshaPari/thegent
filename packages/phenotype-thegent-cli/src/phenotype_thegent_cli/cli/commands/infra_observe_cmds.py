...
from phenotype_thegent_cli.cli.commands.infra_observe_helpers import build_observe_lines
from phenotype_thegent_cli.cli.commands.infra_sitback_helpers import build_dashboard_panels
...
def observe_summary_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.observability_main_impl import observe_summary_impl  # pyright: ignore[reportMissingImports]
...
def cockpit_cmd() -> None:
    ...
    from phenotype_thegent_cli.cli.commands.session_ops_list_impl import ps_impl  # pyright: ignore[reportMissingImports]
...
def sitback_dashboard_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.observability_main_impl import sitback_dashboard_impl  # pyright: ignore[reportMissingImports]
