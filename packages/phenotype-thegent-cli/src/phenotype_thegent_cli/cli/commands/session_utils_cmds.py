...
def history_cmd(limit: int = 50, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import history_impl
...
def events_cmd(run_id: str | None = None, limit: int = 100, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import events_impl
...
def inbox_list_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import inbox_list_impl
...
def inbox_wait_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import inbox_wait_impl
