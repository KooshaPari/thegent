...
def interruption_list_cmd(limit: int = 20, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.cli.commands._cli_shared import _normalize_output_format
    from phenotype_thegent_cli.cli.commands.infra_interruption_helpers import load_recent_interruptions
...
def purge_cmd(dry_run: bool = True) -> None:
    ...
    from phenotype_thegent_cli.cli.commands.impl import purge_impl
