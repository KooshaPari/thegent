...
def session_contracts_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import session_contract_audit_impl
...
def session_contract_health_gate_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import session_contract_health_gate_impl
...
def session_contract_health_report_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import session_contract_health_report_impl
...
def session_contract_health_trend_cmd(
    ...
    from phenotype_thegent_cli.cli.commands.impl import session_contract_health_trend_impl
