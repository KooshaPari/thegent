...
from phenotype_thegent_cli.cli.commands import cli as _cli_surface
from phenotype_thegent_cli.cli.commands import _cli_shared as _shared
...
def __getattr__(name: str) -> Any:
    ...
    if name == "dag_update_cmd":
        from phenotype_thegent_cli.cli.commands import plan_dag_cmds

        return getattr(plan_dag_cmds, name)

    # Forward ThegentSettings to _shared
    if name == "ThegentSettings":
        from phenotype_thegent_cli.cli.commands._cli_shared import ThegentSettings
    ...
    if name in _model_list_funcs:
        from phenotype_thegent_cli.cli.commands import model_cmds_config
        ...
        from phenotype_thegent_cli.cli.commands import model_cmds_rules
