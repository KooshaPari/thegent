...
def run_agent(
    ...
    """
    from phenotype_thegent_cli.cli.commands.cli import bg_cmd, loop_cmd, run_cmd
...
def run_free(
    ...
    """
    from phenotype_thegent_cli.cli.commands.cli import bg_cmd, run_cmd
...
def run_history(
    ...
    from phenotype_thegent_cli.cli.commands.cli import history_cmd
...
def run_logs(
    ...
    from phenotype_thegent_cli.cli.commands.cli import logs_cmd
...
def run_ps(
    ...
    from phenotype_thegent_cli.cli.commands.cli import ps_cmd
...
def run_stop(session_id: str | None = typer.Argument(None, help="Session ID to terminate")) -> None:
    from phenotype_thegent_cli.cli.commands.cli import loop_stop_cmd, stop_cmd
...
def run_fork(
    ...
    from phenotype_thegent_cli.cli.commands.cli import session_fork_cmd
...
def run_rollback(
    ...
    from phenotype_thegent_cli.cli.commands.cli import session_rollback_cmd
