...
def setup_app_callback(ctx: typer.Context) -> None:
    ...
    if ctx.invoked_subcommand is None:
        from phenotype_thegent_cli.cli.commands.cli import setup_cmd
...
def sys_mcp(
    ...
    from phenotype_thegent_protocols.mcp.manage import (
        _get_mcp_url,
        install_to_client,
        migrate_to_unimount,
    ...
    from phenotype_thegent_execution.orchestration.pruning.prune import mcp_prune
...
def sys_session(
    ...
    from phenotype_thegent_cli.cli.commands.cli import session_cmd
...
def sys_shadow(
    ...
    """
    from phenotype_thegent_execution.orchestration.shadow import cleanup_shadows, get_shadow_stats
