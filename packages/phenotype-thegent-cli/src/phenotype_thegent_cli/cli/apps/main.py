...
from phenotype_thegent_cli.cli.apps.project import install_app, scaffold_app, update_app
from phenotype_thegent_cli.cli.apps.project import setup_project_app
from phenotype_thegent_agents.mesh.main import app as mesh_app
from phenotype_thegent_cli.cli.commands import model_cmds

from phenotype_thegent_cli.cli.commands.cli_git import app as git_app
...
def quick_do(prompt: str = typer.Argument(..., help="Prompt to execute")):
    from phenotype_thegent_cli.cli.apps.run import run_agent
...
def review_cmd(
    ...
    # @trace WL-107
    from phenotype_thegent_cli.cli.commands.cli import _format_context_usage_line
    from phenotype_thegent_cli.cli.commands.impl import review_impl
...
def doctor_cmd(
    ...
    from phenotype_thegent_cli.doctor import run_doctor
...
def resume_top_level(
    ...
    from phenotype_thegent_cli.cli.commands.cli import resume_cmd
...
def fork_top_level(
    ...
    from phenotype_thegent_cli.cli.apps.run import run_fork
...
def rollback_top_level(
    ...
    from phenotype_thegent_cli.cli.apps.run import run_rollback
...
def quick_ps(
    ...
    from phenotype_thegent_cli.cli.apps.run import run_ps
...
def hmr_top_level(
    ...
    from phenotype_thegent_protocols.mcp.hotreload import run_prod_hotreload
...
def list_agents_cmd_wrapper() -> None:
    from phenotype_thegent_cli.cli.commands.model_cmds import list_agents_cmd
...
def list_droids_cmd_wrapper(
    ...
    from phenotype_thegent_cli.cli.commands.model_cmds import list_droids_cmd
...
def session_health_gate_wrapper(
    ...
    from phenotype_thegent_cli.cli.commands.session_cmds import session_contract_health_gate_cmd
...
def session_health_report_wrapper(
    ...
    from phenotype_thegent_cli.cli.commands.session_cmds import session_contract_health_report_cmd
...
def session_health_trend_wrapper(
    ...
    from phenotype_thegent_cli.cli.commands.session_cmds import session_contract_health_trend_cmd
...
def domain_map_compat(
    ...
    from phenotype_thegent_cli.cli.commands.domain_map import domain_map_cmd
...
def help_cmd(
    ...
    Example::
        ...
        thegent help doctor
    """
    from phenotype_thegent_cli.cli.help_examples import show_help_examples
