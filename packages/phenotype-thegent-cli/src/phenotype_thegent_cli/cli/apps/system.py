...
def system_install(
    ...
    from phenotype_thegent_cli.cli.system import cmd_install
    import argparse
...
def system_verify(
    ...
    from phenotype_thegent_cli.cli.system import cmd_verify
    import argparse
...
def system_status() -> None:
    ...
    from phenotype_thegent_cli.cli.system import cmd_status
    import argparse
