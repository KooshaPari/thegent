...
def browser_install(
    ...
    from phenotype_thegent_cli.cli.commands.browser import browser_install_cmd
...
def browser_doctor() -> None:
    from phenotype_thegent_cli.cli.commands.browser import browser_doctor_cmd
...
def browser_launch(
    ...
    from phenotype_thegent_cli.cli.commands.browser import browser_launch_cmd
...
def journey_add(
    ...
    from phenotype_thegent_cli.cli.commands.browser import browser_journey_add_cmd
...
def journey_list() -> None:
    from phenotype_thegent_cli.cli.commands.browser import browser_journey_list_cmd
...
def journey_open(
    ...
    from phenotype_thegent_cli.cli.commands.browser import browser_journey_open_cmd
