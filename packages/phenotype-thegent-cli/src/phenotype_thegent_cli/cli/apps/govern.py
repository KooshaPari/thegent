...
def govern_approve(
    ...
    from phenotype_thegent_cli.cli.commands.impl import govern_approve_impl
    from phenotype_thegent_cli.cli.services.governance import govern_get_pending_approval_impl
...
def govern_reject(
    ...
    from phenotype_thegent_cli.cli.commands.impl import govern_reject_impl
...
def govern_vet(
    ...
    from phenotype_thegent_cli.cli.services.governance import govern_vet_impl
...
def govern_register_host(
    ...
    from phenotype_thegent_cli.cli.commands.impl import harness_register_host_impl
...
def govern_resolve_config(
    ...
    from phenotype_thegent_protocols.mcp.server.tools_runtime import config_resolve_impl
...
def govern_negotiate(
    ...
    from phenotype_thegent_protocols.mcp.server.tools_runtime import negotiate_contract_impl

    from phenotype_thegent_cli.cli.commands.session_control_impl import session_contract_negotiate_impl
