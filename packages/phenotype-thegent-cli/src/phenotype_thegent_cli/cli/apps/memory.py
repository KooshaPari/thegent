...
def memory_garden(
    ...
    # @trace WL-060
    """
    from phenotype_thegent_agents.agents.gardener import GardenerAgent
...
def memory_snapshot_list(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_list_cmd
...
def memory_snapshot_index(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_index_cmd
...
def memory_snapshot_export(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_export_cmd
...
def memory_snapshot_prune(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_prune_cmd
...
def memory_snapshot_meta(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_meta_cmd
...
def memory_snapshot_daily_index(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_daily_index_cmd
...
def memory_snapshot_daily_export(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_daily_export_cmd
...
def memory_snapshot_daily_totals(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import snapshot_daily_totals_cmd
...
def memory_dump_index(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import dump_index_cmd
...
def memory_dump_latest(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import dump_latest_cmd
...
def memory_dump_categories(
    ...
    from phenotype_thegent_cli.cli.commands.team_cmds import dump_categories_cmd
