...
def teammates_list():
    from phenotype_thegent_cli.commands.cli_teammates import list_teammates
...
def teammates_delegate(
    ...
    from phenotype_thegent_cli.commands.cli_teammates import delegate_task
...
def teammates_status(
    ...
    from phenotype_thegent_cli.commands.cli_teammates import swarm_status
...
def teammates_show(
    ...
    from phenotype_thegent_cli.commands.cli_teammates import show_delegation
...
def team_create(
    ...
    from phenotype_thegent_cli.commands.cli import team_create_cmd
...
def team_list(format: str = typer.Option("rich", "--format", "-F", help="Output format (rich|json)")):
    from phenotype_thegent_cli.commands.team_commands import team_list_cmd
...
def team_hierarchy(format: str = typer.Option("rich", "--format", "-F", help="Output format (rich|json)")):
    from phenotype_thegent_cli.commands.team_commands import team_hierarchy_cmd
...
def team_crew(format: str = typer.Option("rich", "--format", "-F", help="Output format (rich|json)")):
    from phenotype_thegent_cli.commands.team_commands import team_crew_cmd
