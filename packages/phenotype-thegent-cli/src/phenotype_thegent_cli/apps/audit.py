...
def audit_all(
    ...
    from phenotype_thegent_cli.commands.cli_sync import audit_cmd_impl
...
def audit_security(format: str = typer.Option("rich", "--format", "-F")):
    from phenotype_thegent_cli.commands.cli import compliance_report_cmd, data_protection_cmd
...
def audit_sweep(format: str = typer.Option("rich", "--format", "-F")):
    from phenotype_thegent_cli.commands.cli import sweep_cmd
...
def audit_registry(format: str = typer.Option("rich", "--format", "-F")):
    from phenotype_thegent_cli.commands.cli import audit_verify_cmd
...
def audit_fatigue():
    from phenotype_thegent_cli.commands.cli import interruption_list_cmd
...
def audit_costs(format: str = typer.Option("rich", "--format", "-F")):
    from phenotype_thegent_cli.commands.cli import cost_status_cmd
