...
from phenotype_thegent_cli.apps.project import setup_project_app
...
def setup_app_callback(ctx: typer.Context) -> None:
    ...
    if ctx.invoked_subcommand is None:
        from phenotype_thegent_cli.commands.cli import setup_cmd
...
def sys_session(
    ...
    from phenotype_thegent_cli.commands.cli import session_cmd
