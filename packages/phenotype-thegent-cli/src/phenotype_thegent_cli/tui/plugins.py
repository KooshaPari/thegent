...
class BuiltinPlugins:
    ...
    def create_terminal_plugin(info: PluginInfo) -> Plugin:
        ...
        from phenotype_thegent_cli.tui.widgets.terminal_pane import TerminalPane
    ...
    def create_dialog_plugin(info: PluginInfo) -> Plugin:
        ...
        from phenotype_thegent_cli.tui.widgets.dialog import Dialog, Overlay, Toast
    ...
    def create_status_plugin(info: PluginInfo) -> Plugin:
        ...
        from phenotype_thegent_cli.tui.widgets.statusbar import StatusbarWidget
