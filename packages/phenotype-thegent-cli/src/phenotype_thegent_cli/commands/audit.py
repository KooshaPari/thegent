...
def validate_autosync_profile_drift(
    ...
    from phenotype_thegent_planning.phases.compliance_profile import validate_profile_drift
...
def audit_cmd(
    ...
    from phenotype_thegent_audit.audit.system_audit import AuditReport, AuditStatus, SystemAuditor
    ...
    if category:
        ...
        from phenotype_thegent_audit.audit.system_audit import AuditReport
