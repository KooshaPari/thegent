"""DAG command handlers extracted from cli.py (WL-120 B90-W2-A1).

All dag_*_cmd functions from the legacy cli.py monolith.
These functions are pure CLI surface: they call impl/dag_impl helpers
and print results. No business logic lives here.
"""
...
from phenotype_thegent_cli.commands.dag_impl import (
    _atomic_write,
    _check_dag_cycles,
    _dag_path,
    _dag_update_task,
...
from phenotype_thegent_cli.commands._cli_shared import _resolve_checkpoint_id
from phenotype_thegent_cli.services.run_session_helpers import (
