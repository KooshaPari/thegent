...
def ps_impl(
    ...
    """
    from phenotype_thegent_cli.commands.impl import _default_owner_tag, _is_pid_running, _session_paths
...
def session_list_impl(
    ...
    from phenotype_thegent_cli.commands.impl import _default_owner_tag
...
def logs_impl(session_id: str, tail: int | None = None, stderr: bool = False, follow: bool = False) -> str | None:
    ...
    from phenotype_thegent_cli.commands.impl import _default_owner_tag, _resolve_cwd, _session_paths
    from phenotype_thegent_execution.execution import AuditEntry, AuditRegistry
    ...
    if follow:
        try:
            ...
            with target.open("r", encoding="utf-8", errors="replace") as f:
                if tail and tail > 0:
                    from phenotype_thegent_core.utils.helpers import read_file_tail
        ...
        from phenotype_thegent_core.utils.helpers import read_file_tail, safe_read_file
