...
def tools_list(
    ...
    from phenotype_thegent_core.utils.borrow import ToolBorrower
...
def tools_borrow(
    tool_names: Annotated[
        str | None,
        typer.Argument(
            help="Comma-separated tool names to borrow (e.g. phenotype_thegent_run,phenotype_thegent_ps). Omit to borrow all tools."
        ),
    ] = None,
    ...
    Examples::
        ...
        thegent tools borrow phenotype_thegent_run,phenotype_thegent_ps,phenotype_thegent_ddg_search

        # Write to a different project directory
        thegent tools borrow --output-dir ../my-other-project

        # Also print the CLAUDE.md snippet
        thegent tools borrow phenotype_thegent_run,phenotype_thegent_ps --claude-md
    ...
    from phenotype_thegent_core.utils.borrow import BorrowConfig, ToolBorrower
...
def tools_show(
    ...
    Examples::
        ...
        thegent tools show phenotype_thegent_run
        thegent tools show phenotype_thegent_ddg_search --json
    """
    from rich.console import Console
...
def tools_snippet(
    ...
    Examples::
        ...
        thegent tools snippet phenotype_thegent_run,phenotype_thegent_ps,phenotype_thegent_ddg_search
    """
    from phenotype_thegent_core.utils.borrow import BorrowConfig, ToolBorrower
