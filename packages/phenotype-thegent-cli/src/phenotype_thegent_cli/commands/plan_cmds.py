...
from phenotype_thegent_cli.commands.plan_output_helpers import (
    render_dag_list,
    render_dag_ready,
    render_dag_status,
...
from phenotype_thegent_cli.commands.run_cmds import bg_cmd  # noqa: E402
from phenotype_thegent_cli.commands.session_cmds import history_cmd  # noqa: E402
...
def dag_status_cmd(cd: Path | None = None, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.dag_impl import dag_status_impl
...
def plan_incorporate_cmd(cd: Path | None = None, dry_run: bool = False) -> None:
    ...
    from phenotype_thegent_cli.commands.work_stream_impl import incorporate_impl
...
def plan_claim_cmd(item_id: str, agent_id: str | None = None, cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.work_stream_impl import work_stream_claim_impl
    from phenotype_thegent_agents.discovery import get_current_agent_id
...
def plan_complete_cmd(item_id: str, agent_id: str | None = None, cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.work_stream_impl import work_stream_complete_impl
    from phenotype_thegent_agents.discovery import get_current_agent_id
...
def plan_lint_workstream_cmd(cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_core.utils.workstream_ops import WorkStreamOps
...
def plan_wait_next_cmd(
    ...
    from phenotype_thegent_cli.commands.work_stream_impl import wait_next_impl
...
def plan_do_next_cmd(cd: Path | None = None, limit: int = 5, format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.work_stream_impl import do_next_impl
...
def plan_analyze_cmd(
    ...
    from phenotype_thegent_cli.commands.impl import plan_analyze_impl
...
def workstream_dashboard_cmd() -> None:
    ...
    from phenotype_thegent_cli.tui.workstream_dashboard import run_dashboard
...
def workstream_launch_cmd() -> None:
    ...
    from phenotype_thegent_planning.planning.auto_launch import AutoLaunchSystem
