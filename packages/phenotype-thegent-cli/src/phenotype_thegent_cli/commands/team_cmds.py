...
def summary_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.memory import MemoryCategory, MemorySystem
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_agents.summary import summary_impl
...
def snapshot_list_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_list_payload
...
def snapshot_index_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_index_payload
...
def snapshot_export_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_export_payload
...
def snapshot_prune_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_prune_payload
...
def snapshot_meta_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_triggers_tags_payload
...
def snapshot_daily_index_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_daily_index_payload
...
def snapshot_daily_totals_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_daily_totals_payload
...
def snapshot_daily_export_cmd(
    ...
    from phenotype_thegent_execution.orchestration.state.session_scraper import SessionScraper
    from phenotype_thegent_execution.orchestration.state.session_snapshot_cli_helpers import snapshot_daily_export_payload
...
def explain_cmd(run_id: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import history_impl
...
def handoff_cmd(owner: str) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import escalate_list_impl
    from phenotype_thegent_execution.execution import HandoffManager, RunRegistry
...
def handoff_show_cmd(snapshot_id: str, format: str | None = None) -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_execution.execution import HandoffManager
...
def watchdog_cmd(max_idle_s: int = 3600) -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_execution.execution import ContinuityWatchdog
...
def traffic_cmd() -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_execution.execution import KPIManager
...
def drift_monitor_cmd(prompt: str, agents: list[str]) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import run_impl
...
def teammates_delegate_cmd(
    ...
    from phenotype_thegent_audit.governance.handoff import HandoffIntegrity
    from phenotype_thegent_audit.governance.teammates import TeammateManager
...
def queue_list_cmd(watch: bool = False) -> None:
    ...
    from phenotype_thegent_cli.commands.queue_commands import queue_list_cmd as _queue_list_cmd_impl
...
def team_create_cmd(name: str, leader: str | None = None, teammates: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.team_commands import team_create_cmd as _team_create_cmd_impl
...
def team_task_add_cmd(team_id: str, title: str, description: str) -> None:
    """Backward-compatible wrapper for extracted team command group."""
    from phenotype_thegent_cli.commands.team_commands import team_task_add_cmd as _team_task_add_cmd_impl
...
def team_task_list_cmd(team_id: str) -> None:
    """Backward-compatible wrapper for extracted team command group."""
    from phenotype_thegent_cli.commands.team_commands import team_task_list_cmd as _team_task_list_cmd_impl
...
def project_register_cmd(path: Path, name: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.project_commands import project_register_cmd as _project_register_cmd_impl
...
def project_list_cmd(
    ...
    """Backward-compatible wrapper for extracted project command group."""
    from phenotype_thegent_cli.commands.project_commands import project_list_cmd as _project_list_cmd_impl
