...
def lock_resource_impl(resource_path: str, agent_id: str, ttl: int = 60, cd: Path | None = None) -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.commands.impl import _resolve_cwd
...
def monitor_impl(interval: float = 2.0) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import do_next_impl, ps_impl as _ps_impl
...
def orchestrate_plan_impl(
    ...
    *,
    ...
    from phenotype_thegent_agents.plangent import LLMPlangentPlanner
...
def orchestrate_run_impl(
    ...
    *,
    ...
    from phenotype_thegent_agents.plangent import LLMPlangentPlanner, PlangentExecutor
