...
from phenotype_thegent_observability.observability.prometheus import get_metrics_collector
from phenotype_thegent_core.utils.workstream_ops import _atomic_write, _locked_file_access
from phenotype_thegent_sync.sync.dead_letter_queue import (
...
if TYPE_CHECKING:
    from phenotype_thegent_sync.integrations.sync_policy_contract import ConnectorPolicy, SyncPolicyContract
...
from phenotype_thegent_cli.commands.sync_types import OperationResult, SyncOperationStatus, SyncResult
...
class SyncCommand:
    ...
    def sync_rules(self, dry_run: bool = False) -> OperationResult:
        ...
        from phenotype_thegent_core.core.rules_sync import RulesSyncManager
    ...
    def sync_research(self, dry_run: bool = False) -> OperationResult:
        ...
        try:
            ...
            from phenotype_thegent_cli.cli.commands.impl import incorporate_impl
    ...
    def sync_agents(self, dry_run: bool = False) -> OperationResult:
        ...
        try:
            from phenotype_thegent_agents.agents.registry import AGENT_NAMES
    ...
    def _load_sync_policy_contract_if_present(self) -> SyncPolicyContract | None:
        ...
        from phenotype_thegent_sync.integrations.sync_policy_contract import (
    ...
    def _perform_board_sync(
        ...
        *,
        ...
        """
        from phenotype_thegent_sync.sync.board_adapters import resolve_board_adapter
    ...
    def migrate_legacy_board_ids(self, legacy_ids: list[str], dry_run: bool = False) -> OperationResult:
        ...
        from phenotype_thegent_sync.integrations.board_id_guard import migrate_legacy_board_id
        from phenotype_thegent_sync.integrations.board_id_uniqueness import validate_unique_board_ids
    ...
    def detect_remote_orphans(self, remote_ids: list[str]) -> OperationResult:
        ...
        from phenotype_thegent_sync.integrations.sync_auditor import SyncAuditor
    ...
    def detect_local_orphans(self, mapping_cache_path: Path | None = None) -> OperationResult:
        ...
        from phenotype_thegent_sync.integrations.connector_mapping_cache import ConnectorMappingCache
        from phenotype_thegent_sync.integrations.sync_auditor import SyncAuditor
