...
from phenotype_thegent_agents.agents import list_agent_names, resolve_agent
...
def _session_status_for(session_id: str, settings: ThegentSettings) -> str:
    ...
    from phenotype_thegent_cli.commands.impl import _find_session_meta, _is_pid_running, _read_session_meta, _session_paths
...
def rules_sync_impl(cd: Path | None = None, force: bool = False, check: bool = False) -> dict[str, Any]:  # pyright: ignore[reportUnusedVariable]
    ...
    from phenotype_thegent_skills.rules.sync import RulesSync
