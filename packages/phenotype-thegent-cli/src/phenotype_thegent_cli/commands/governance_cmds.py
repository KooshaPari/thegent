...
from phenotype_thegent_cli.commands.governance_health_helpers import (
...
def data_protection_cmd(format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import get_data_protection_status_impl
...
def compliance_report_cmd(
    ...
    from phenotype_thegent_cli.commands.impl import get_compliance_report_impl
...
def audit_verify_cmd(format: str | None = None) -> None:
    ...
    from phenotype_thegent_execution.execution import Auditor
...
def escalate_add_cmd(
    ...
    from phenotype_thegent_cli.commands.impl import escalate_add_impl
...
def sweep_cmd(
    ...
    from phenotype_thegent_cli.commands.impl import sweep_impl
...
def escalate_resolve_cmd(run_id: str | None = None, resolution: str = "resolved") -> None:
    ...
    from phenotype_thegent_cli.commands.impl import escalate_resolve_impl
...
def escalate_approve_cmd(run_id: str | None = None) -> None:
    ...
    rid = _resolve_run_id(run_id)
    from phenotype_thegent_cli.commands.impl import escalate_approve_impl
...
def govern_approve_cmd(run_id: str, reason: str | None = None) -> None:
    ...
    """
    from phenotype_thegent_cli.commands.impl import govern_approve_impl
    from phenotype_thegent_cli.services.governance import govern_get_pending_approval_impl
    from phenotype_thegent_audit.governance.diff_renderer import DiffPayload, DiffRenderer
...
def govern_reject_cmd(run_id: str, reason: str | None = None) -> None:
    ...
    """
    from phenotype_thegent_cli.commands.impl import govern_reject_impl
...
def govern_list_pending_cmd(format: str | None = None) -> None:
    ...
    from phenotype_thegent_cli.commands.impl import govern_list_pending_impl
    from phenotype_thegent_audit.governance.diff_renderer import DiffPayload, DiffRenderer
...
def govern_go_health_cmd(cd: Path | None = None, format: str | None = None) -> None:
    ...
    from phenotype_thegent_audit.governance.health_score import HealthScoreComputer, get_band
    from phenotype_thegent_audit.governance.scanner import CodebaseScanner
...
def govern_go_status_cmd(cd: Path | None = None) -> None:
    ...
    from phenotype_thegent_audit.governance.agileplus import AgilePlusLoop
...
def contracts_conformance_cmd(
    ...
    from phenotype_thegent_core.contracts.conformance import run_conformance_suite
...
def trust_status_cmd(format: str | None = None) -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_execution.execution import TrustBoundaryValidator
...
def compliance_siem_test_cmd(message: str, severity: str = "low") -> None:
    ...
    from phenotype_thegent_observability.observability.egress import EgressEvent, SIEMEgress
...
def compliance_plugin_check_cmd(plugin_id: str, signature: str) -> None:
    ...
    from phenotype_thegent_core.contracts.marketplace import PluginContract, PluginVerifier
...
def compliance_redact_cmd(text: str) -> None:
    ...
    from phenotype_thegent_audit.governance.support import SupportRedactor
...
def guardrails_check_cmd(prompt: str, agent: str | None = None, model: str | None = None) -> None:
    ...
    from phenotype_thegent_audit.governance.input_guardrails import InputGuardrails
...
def policy_check_cmd(agent: str, model: str | None = None, lane: str = "standard", confidence: float = 1.0) -> None:
    ...
    settings = ThegentSettings()
    from phenotype_thegent_execution.execution import PolicyEngine, RunMeta, RunRegistry
...
def discovery_register_cmd(
    ...
    from phenotype_thegent_agents.discovery import register_discovered_agent
...
def discovery_parse_cmd(
    ...
    from phenotype_thegent_agents.discovery import register_discovered_agent
    from phenotype_thegent_core.parser import parse_cli_output
...
def discovery_scan_cmd(
    ...
    from phenotype_thegent_agents.discovery import list_discovered_agents, scan_agent_processes
