...
def _impl_settings():
    from phenotype_thegent_cli.commands import impl as cli_impl
...
def wait_impl(session_id: str, timeout: int | None = None) -> dict[str, Any]:
    ...
    """
    from phenotype_thegent_cli.commands.impl import _is_pid_running, _session_paths, time
...
def session_send_impl(session_id: str, message: str, msg_type: str = "reprompt") -> tuple[bool, str]:
    ...
    from phenotype_thegent_cli.commands.impl import _default_owner_tag, _resolve_cwd
    from phenotype_thegent_execution.execution import AuditEntry, AuditRegistry, MessageEntry, MessageRegistry
...
def stop_impl(session_id: str, force: bool = False) -> dict[str, Any]:
    ...
    """
    from phenotype_thegent_cli.commands.impl import _is_pid_running
...
def metrics_impl() -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.commands.session_ops_impl import ps_impl
...
def prune_sessions_impl(days: int | None = None) -> dict[str, Any]:
    ...
    from phenotype_thegent_cli.commands.impl import _is_pid_running, _session_paths
...
def session_contract_negotiate_impl(contract_id: str, supported_versions: list[str]) -> dict[str, Any]:
    ...
    """
    from phenotype_thegent_core.contracts.registry import ContractNegotiator
