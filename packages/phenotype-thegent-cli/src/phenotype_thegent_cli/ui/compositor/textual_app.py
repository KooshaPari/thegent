...
def _get_base_layout():  # noqa: ANN202 -- lazy import helper, return type depends on import
    from phenotype_thegent_cli.tui.layouts.base import BaseLayout  # noqa: PLC0415 -- deferred to break circular import

    return BaseLayout


def _get_menubar_widget():  # noqa: ANN202 -- lazy import helper, return type depends on import
    from phenotype_thegent_cli.tui.widgets.menubar import MenubarWidget  # noqa: PLC0415 -- deferred to break circular import
