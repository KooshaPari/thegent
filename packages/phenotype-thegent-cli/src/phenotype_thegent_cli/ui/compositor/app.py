...
from phenotype_thegent_cli.ui.compositor.pane_manager import PaneManager, PaneNode

if TYPE_CHECKING:
    from phenotype_thegent_cli.ui.compositor.session_state import SessionState
    from phenotype_thegent_cli.ui.compositor.terminal_pane import PanelMounted, PanelUnmounted
    ...
    def action_new_pane(self) -> None:
        ...
        try:
            ...
            # Create first split
                ...
                from phenotype_thegent_cli.ui.compositor.pane_manager import PaneNode
