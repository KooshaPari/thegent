...
from phenotype_thegent_gitops.git import GitParallelismManager
from phenotype_thegent_gitops.worktree import WorktreePool
...
def lock_cleanup_main(
    ...
    if ctx.invoked_subcommand is not None:
        return
    from phenotype_thegent_gitops.lock_cleanup import run_lock_cleanup
...
def lock_cleanup_service(
    ...
    from phenotype_thegent_gitops.lock_cleanup import (
