...
try:
    import phenotype_thegent_git

    _native_available = True
except ImportError:
    phenotype_thegent_git = None
...
class GitNative:
    ...
    def head(self) -> dict[str, Any]:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "get_head_sha"):
            sha = phenotype_thegent_git.get_head_sha(self.repo_path)
            branch = phenotype_thegent_git.get_branch_name(self.repo_path)
    ...
    def status(self) -> dict[str, Any]:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "get_status"):
            return phenotype_thegent_git.get_status(self.repo_path)
    ...
    def diff_stat(self) -> dict[str, Any]:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "diff_stat"):
            return phenotype_thegent_git.diff_stat("HEAD", self.repo_path)
    ...
    def list_branches(self, all_remotes: bool = False) -> list[str]:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "list_branches"):
            return phenotype_thegent_git.list_branches(self.repo_path, all_remotes)
    ...
    def list_remotes(self) -> dict[str, str]:
        ...
        if _native_available:
            ...
            if hasattr(phenotype_thegent_git, "list_remotes"):
                return phenotype_thegent_git.list_remotes(self.repo_path)
    ...
    def log(self, max_count: int = 10, oneline: bool = True) -> list[str]:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "get_log"):
            return phenotype_thegent_git.get_log(self.repo_path, max_count, oneline)
    ...
    def fetch(self, remote: str | None = None, prune: bool = False) -> bool:
        ...
        Returns:
            True if successful
        """
        if _native_available and hasattr(phenotype_thegent_git, "fetch"):
            return phenotype_thegent_git.fetch(self.repo_path, remote, prune)
    ...
    def has_changes(self) -> bool:
        ...
        """
        if _native_available and hasattr(phenotype_thegent_git, "has_changes"):
            return phenotype_thegent_git.has_changes(self.repo_path)
