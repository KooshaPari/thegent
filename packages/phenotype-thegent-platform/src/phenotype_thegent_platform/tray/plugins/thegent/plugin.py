...
from phenotype_thegent_platform.tray.core.plugin_system import SidebarItem, TrayPlugin
...
class ThegentPlugin(TrayPlugin):
    ...
    def get_tab(self, tab_id: str) -> QWidget | None:
        ...
        try:
            from phenotype_thegent_platform.tray.plugins.thegent.tabs import get_tab  # noqa: PLC0415
        except ImportError:
