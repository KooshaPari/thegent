...
from phenotype_thegent_platform.tray.plugins.thegent.tabs.agents import (
    AgentEditDialog,
    AgentsTab,
)
from phenotype_thegent_platform.tray.plugins.thegent.tabs.agents import (
...
from phenotype_thegent_platform.tray.plugins.thegent.tabs.costs import (
    CostAlertDialog,
    CostsTab,
)
from phenotype_thegent_platform.tray.plugins.thegent.tabs.costs import (
...
from phenotype_thegent_platform.tray.plugins.thegent.tabs.gardener import (
...
from phenotype_thegent_platform.tray.plugins.thegent.tabs.projects import (
    ProjectEditDialog,
    ProjectsTab,
)
from phenotype_thegent_platform.tray.plugins.thegent.tabs.projects import (
...
from phenotype_thegent_platform.tray.plugins.thegent.tabs.gamification import (
    AchievementsDialog,
    GamificationTab,
)
from phenotype_thegent_platform.tray.plugins.thegent.tabs.gamification import (
...
if TYPE_CHECKING:
    ...
    from phenotype_thegent_platform.tray.plugins.thegent.api_client import ThegentAPIClient
