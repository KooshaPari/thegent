...
def phenotype_thegent_list_operations_impl(
    *,
    operation: str | None,
    stable_json_impl: Callable[[Any], str],
    error_result_impl: Callable[..., ToolResult],
) -> ToolResult:
    from phenotype_thegent_agents.operations import Operation, get_operations_by_type, list_operations
...
def phenotype_thegent_list_modes_impl(
    *,
    mode: str | None,
    stable_json_impl: Callable[[Any], str],
    error_result_impl: Callable[..., ToolResult],
) -> ToolResult:
    from phenotype_thegent_execution.orchestration_modes import get_mode, list_modes
...
def phenotype_thegent_list_agents_impl(
    *,
...
def phenotype_thegent_suggest_mode_impl(
    *,
    risk: str,
    urgency: str,
    confidence: float,
) -> ToolResult:
    from phenotype_thegent_execution.orchestration_modes import get_mode, suggest_mode
...
def phenotype_thegent_list_droids_impl(
    *,
    cd: str | None,
    default_cwd: Any,
    list_droids_impl: Callable[..., list[dict[str, Any]]],
) -> ToolResult:
...
def phenotype_thegent_list_models_impl(
    *,
    provider: str | None,
...
def phenotype_thegent_resolve_model_route_impl(
    *,
    model: str,
    provider: str | None,
    policy: str,
