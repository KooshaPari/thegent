...
async def run_lifespan(
    ...
    *,
    ...
    try:
        from phenotype_thegent_core.infra.runtime_init import initialize_runtime_infrastructure
    ...
    if mounts_enabled:
        try:
            ...
            if settings.mcp_mount_serena:
                from phenotype_thegent_cli.lsp.serena_integration import detect_serena_backend, get_serena_mcp_config
    ...
    if settings.bundle_proxy:
        try:
            from phenotype_thegent_agents.agents.cliproxy_manager import start_proxy_managed
    ...
    try:
        ...
        try:
            from phenotype_thegent_core.utils.routing_impl.litellm_responses_handler import close_http_client
