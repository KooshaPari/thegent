...
from phenotype_thegent_skills.skills.discovery import discover_skills, load_skill
...
def phenotype_thegent_list_skills_impl(*, backend: SkillBackend) -> ToolResult:
...
def phenotype_thegent_activate_skill_impl(
    *,
    skill_name: Any,
    ...
    if skill is None:
        return error_result_impl(
            ...
            "Call phenotype_thegent_list_skills and retry with a listed name.",
