...
def register_workflow_prompts(
    *,
    ...
    def thegent_workflow_idea(idea: str) -> str:
        ...
        """
        return server_resource_workflow.thegent_workflow_idea_impl(idea)
    ...
    def thegent_workflow_quality_green() -> str:
        ...
        """
        return server_resource_workflow.thegent_workflow_quality_green_impl()
    ...
    def thegent_workflow_next_item() -> str:
        ...
        """
        return server_resource_workflow.thegent_workflow_next_item_impl()
    ...
    def thegent_workflow_gardening() -> str:
        ...
        """
        return server_resource_workflow.thegent_workflow_gardening_impl()
...
def thegent_run_agent_prompt_impl(*, agent: str, prompt: str, cd: str | None, mode: str) -> str:
    cd_hint = f" in directory {cd}" if cd else ""
    return f"Run agent '{agent}'{cd_hint} with mode '{mode}'. Task: {prompt}"


def thegent_create_wbs_prompt_impl(*, feature: str, scope: str | None) -> str:
...
def thegent_bg_task_prompt_impl(*, agent: str, prompt: str, owner: str | None) -> str:
