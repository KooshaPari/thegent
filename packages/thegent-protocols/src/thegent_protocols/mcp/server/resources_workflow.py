...
def thegent_workflow_idea_impl(idea: str) -> str:
...
def thegent_workflow_quality_green_impl() -> str:
...
def thegent_workflow_next_item_impl() -> str:
...
def thegent_workflow_gardening_impl() -> str:
