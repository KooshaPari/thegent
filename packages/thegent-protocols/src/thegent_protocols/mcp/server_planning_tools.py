...
def register_planning_tools(
    *,
    ...
    async def thegent_dag_list(
        ...
        return await server_tools_planning.thegent_dag_list_impl(
            cd=cd,
    ...
    def thegent_do_next(cd: str | None = None, limit: int = 5) -> ToolResult:
        ...
        return server_tools_planning.thegent_do_next_impl(
            cd=cd,
            limit=limit,
    ...
    def thegent_lock_resource(resource: str, ttl: int = 60, cd: str | None = None) -> ToolResult:
        ...
        return server_tools_locking_planning.thegent_lock_resource_impl(
            resource=resource,
            ttl=ttl,
            cd=cd,
            error_result_impl=error_result,
    ...
    def thegent_unlock_resource(resource: str, token: str, cd: str | None = None) -> ToolResult:
        ...
        return server_tools_locking_planning.thegent_unlock_resource_impl(
            resource=resource,
            token=token,
            cd=cd,
        )
    ...
    def thegent_verify_context(files: list[str], cd: str | None = None) -> ToolResult:
        ...
        return server_tools_locking_planning.thegent_verify_context_impl(
            files=files,
            cd=cd,
        )
    ...
    def thegent_plan_get_next(cd: str | None = None) -> ToolResult:
        ...
        return server_tools_planning.thegent_plan_get_next_impl(
            cd=cd,
            do_next_impl=do_next_impl,
            error_result_impl=error_result,
        )
    ...
    def thegent_plan_wait_next(
        ...
        return server_tools_planning.thegent_plan_wait_next_impl(
            cd=cd,
            poll=poll,
            timeout=timeout,
            sources=sources,
    ...
    def thegent_history(limit: int = 50) -> ToolResult:
        ...
        return server_tools_planning.thegent_history_impl(
            limit=limit,
    ...
    def thegent_plan_progress(limit: int = 10) -> ToolResult:
        ...
        return server_tools_planning.thegent_plan_progress_impl(
            limit=limit,
            history_impl=history_impl,
        )
    ...
    def thegent_plan_analyze(
        ...
        return server_tools_planning.thegent_plan_analyze_impl(
            cd=cd,
            pert=pert,
            resources=resources,
    ...
    def thegent_retry(
        ...
        return server_tools_locking_planning.thegent_retry_impl(
            run_id=run_id,
    ...
    def thegent_plan_incorporate(cd: str | None = None, dry_run: bool = False) -> ToolResult:
        ...
        return server_tools_locking_planning.thegent_plan_incorporate_impl(
            cd=cd,
            dry_run=dry_run,
    ...
    def thegent_dag_status(cd: str | None = None) -> ToolResult:
        ...
        return server_tools_contract_observe.thegent_dag_status_impl(
            cd=cd,
    ...
    def thegent_escalate_list(past_sla_only: bool = False, limit: int = 50) -> ToolResult:
        ...
        return server_tools_escalation.thegent_escalate_list_impl(
    ...
    def thegent_escalate_add(
        ...
        return server_tools_escalation.thegent_escalate_add_impl(
            run_id=run_id,
            reason=reason,
    ...
    def thegent_escalate_approve(run_id: str) -> ToolResult:
        ...
        return server_tools_escalation.thegent_escalate_approve_impl(
            run_id=run_id,
    ...
    def thegent_escalate_resolve(run_id: str, resolution: str = "resolved") -> ToolResult:
        ...
        return server_tools_escalation.thegent_escalate_resolve_impl(
            run_id=run_id,
    ...
    def thegent_govern_list_pending() -> ToolResult:
        ...
        return server_tools_escalation.thegent_govern_list_pending_impl(
