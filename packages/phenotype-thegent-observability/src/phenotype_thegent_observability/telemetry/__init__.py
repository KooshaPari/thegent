...
Usage:
    from phenotype_thegent_observability.telemetry import instrument_genai_call, instrument_run_bg_status

    with instrument_genai_call(agent_name="claude", model="claude-3-5-sonnet", run_id=run_id):
        ...
"""

from phenotype_thegent_observability.observability.otel_instrumentation import (
