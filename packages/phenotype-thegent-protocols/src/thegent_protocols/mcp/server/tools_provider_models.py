...
def register_provider_model_tools(
    *, mcp: FastMCP
    ...
    def list_providers(include_credentials: bool = False) -> str:
        ...
        from thegent_routing.provider_model_manager import list_providers as _list_providers
    ...
    def get_provider(name: str) -> str:
        ...
        from thegent_routing.provider_model_manager import get_provider as _get_provider
    ...
    def add_provider(
        ...
        from thegent_routing.provider_model_manager import add_provider as _add_provider
    ...
    def update_provider(
        ...
        from thegent_routing.provider_model_manager import update_provider as _update_provider
    ...
    def delete_provider(name: str, remove_credentials: bool = True) -> str:
        ...
        from thegent_routing.provider_model_manager import delete_provider as _delete_provider
    ...
    def list_credentials() -> str:
        ...
        from thegent_routing.provider_model_manager import list_credentials as _list_credentials
    ...
    def add_api_key(provider: str, api_key: str) -> str:
        ...
        from thegent_routing.provider_model_manager import add_api_key as _add_api_key
    ...
    def remove_api_key(provider: str) -> str:
        ...
        from thegent_routing.provider_model_manager import remove_api_key as _remove_api_key
    ...
    def validate_provider(name: str) -> str:
        ...
        from thegent_routing.provider_model_manager import validate_provider as _validate_provider
    ...
    def discover_models(provider: str | None = None) -> str:
        ...
        from thegent_routing.provider_model_manager import discover_models as _discover_models
    ...
    def list_models(provider: str | None = None) -> str:
        ...
        from thegent_routing.provider_model_manager import list_models as _list_models
    ...
    def add_model_alias(provider: str, model: str, alias: str) -> str:
        ...
        from thegent_routing.provider_model_manager import add_model_alias as _add_model_alias
    ...
    def remove_model_alias(provider: str, alias: str) -> str:
        ...
        from thegent_routing.provider_model_manager import remove_model_alias as _remove_model_alias
