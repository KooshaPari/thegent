...
def register_harness_tools(
    ...
    Returns:
        Tuple of (phenotype_thegent_harness_interact, phenotype_thegent_harness_list_actions,
                  phenotype_thegent_harness_get_command, phenotype_thegent_harness_register_host)
    """

    @mcp.tool(annotations={"readOnlyHint": True, "idempotentHint": True})
    async def phenotype_thegent_harness_interact(
        harness: str,
        action: str,
    ...
    @mcp.tool(annotations={"readOnlyHint": True, "idempotentHint": True})
    async def phenotype_thegent_harness_list_actions() -> str:
    ...
    @mcp.tool(annotations={"readOnlyHint": True, "idempotentHint": True})
    async def phenotype_thegent_harness_get_command(
        harness: str,
        action: str,
    ) -> str:
    ...
    async def phenotype_thegent_harness_register_host(
        host_id: str,
        harness: str,
        command_prefix: str = "",
    ...
    return (
        phenotype_thegent_harness_interact,
        phenotype_thegent_harness_list_actions,
        phenotype_thegent_harness_get_command,
        phenotype_thegent_harness_register_host,
    )
