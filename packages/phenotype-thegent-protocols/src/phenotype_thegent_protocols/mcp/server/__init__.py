...
from phenotype_thegent_protocols.mcp import server_module_loader as _server_tools_dynamic_registry
...
phenotype_thegent_lifespan = None  # Set at runtime via server.py
