...
def phenotype_thegent_lock_resource_impl(
    *,
    resource: str,
    ttl: int,
    cd: str | None,
    ...
    from phenotype_thegent_cli.cli.commands.impl import _default_owner_tag, lock_resource_impl
...
def phenotype_thegent_unlock_resource_impl(
    *,
    resource: str,
    token: str,
    cd: str | None,
) -> ToolResult:
    from phenotype_thegent_cli.cli.commands.impl import _default_owner_tag, unlock_resource_impl
...
def phenotype_thegent_verify_context_impl(
    *,
    files: list[str],
    cd: str | None,
) -> ToolResult:
    from phenotype_thegent_cli.cli.commands.impl import verify_context_impl
...
def phenotype_thegent_retry_impl(
    *,
    run_id: str,
...
def phenotype_thegent_plan_incorporate_impl(
    *,
    cd: str | None,
    dry_run: bool,
