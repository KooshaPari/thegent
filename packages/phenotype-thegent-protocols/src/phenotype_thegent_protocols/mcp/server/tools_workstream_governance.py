...
def register_workstream_governance_tools(
    *,
    ...
    def phenotype_thegent_workstream_query(query: str) -> ToolResult:
        """
    ...
    @mcp.tool(annotations={"readOnlyHint": True, "idempotentHint": True})
    def phenotype_thegent_workstream_stats() -> ToolResult:
        """
    ...
    @mcp.tool(annotations={"readOnlyHint": True, "idempotentHint": True})
    def phenotype_thegent_heliosShield_status() -> ToolResult:
        """
        Get status from thegent.mesh harness.
        """
        from phenotype_thegent_skills.skills.terminal import heliosShield_status
    ...
    def phenotype_thegent_govern_approve(run_id: str, reason: str | None = None) -> ToolResult:
        """
        ...
        """
        return server_tools_governance.phenotype_thegent_govern_approve_impl(
            run_id=run_id,
            reason=reason,
    ...
    @mcp.tool(annotations={"readOnlyHint": False, "destructiveHint": False, "idempotentHint": False})
    def phenotype_thegent_govern_reject(run_id: str, reason: str | None = None) -> ToolResult:
        """
        ...
        """
        return server_tools_governance.phenotype_thegent_govern_reject_impl(
            run_id=run_id,
            reason=reason,
    ...
    return (
        phenotype_thegent_workstream_query,
        phenotype_thegent_workstream_stats,
        phenotype_thegent_heliosShield_status,
        phenotype_thegent_govern_approve,
        phenotype_thegent_govern_reject,
    )
