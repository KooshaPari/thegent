...
def register_dynamic_registry_tools(
    *,
    ...
    Returns:
        (phenotype_thegent_register_tool, phenotype_thegent_complete_tool_call, phenotype_thegent_list_dynamic_tools)
    """

    @mcp.tool(annotations={"readOnlyHint": False, "destructiveHint": False, "idempotentHint": False})
    async def phenotype_thegent_register_tool(
        session_id: str,
        name: str,
        description: str,
        ...
        emitted to the client via phenotype_thegent_session_send dynamic_tool_invoke flow.
        ...
        """
        from phenotype_thegent_protocols.mcp.dynamic_tools import DynamicToolSpec
    ...
    @mcp.tool(annotations={"readOnlyHint": False, "destructiveHint": False, "idempotentHint": False})
    async def phenotype_thegent_complete_tool_call(
        session_id: str,
        call_id: str,
        output: str,
        success: bool,
    ...
    async def phenotype_thegent_list_dynamic_tools(
        session_id: str,
    ) -> str:
    ...
    return phenotype_thegent_register_tool, phenotype_thegent_complete_tool_call, phenotype_thegent_list_dynamic_tools
