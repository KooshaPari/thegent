...
def phenotype_thegent_plan_get_next_impl(
    *,
    cd: str | None,
...
async def phenotype_thegent_dag_list_impl(
    *,
    cd: str | None,
    default_cwd: Any,
    ctx: Any,
...
def phenotype_thegent_do_next_impl(
    *,
    cd: str | None,
    limit: int,
    do_next_impl: Callable[..., dict[str, Any]],
...
def phenotype_thegent_plan_wait_next_impl(
    *,
    cd: str | None,
    poll: float,
    timeout: float,
...
def phenotype_thegent_history_impl(
    *,
    limit: int,
...
def phenotype_thegent_plan_progress_impl(
    *,
    limit: int,
    history_impl: Callable[..., list[dict[str, Any]]],
) -> ToolResult:
...
def phenotype_thegent_plan_analyze_impl(
    *,
    cd: str | None,
    pert: bool,
    resources: bool,
