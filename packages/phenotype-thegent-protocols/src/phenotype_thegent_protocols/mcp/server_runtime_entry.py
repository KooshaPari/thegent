...
def register_runtime_entry(
    *,
    ...
    async def phenotype_thegent_acp_invoke(
        agent_url: str,
        task: str,
        payload: str = "{}",
    ) -> str:
        ...
        from phenotype_thegent_core.adapters.acp_client import ACPClient, ACPServerUnreachableError
        from phenotype_thegent_core.adapters.acp_mcp_bridge import ACPAgentCallError, AcpMcpBridge
    ...
    return (health, _get_event_store, phenotype_thegent_acp_invoke, http_app, http_app_factory, run)
