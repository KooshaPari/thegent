...
if TYPE_CHECKING:
    from thegent_infra.resource_limits import ResourceLimits
    from thegent_infra.resource_monitor import ResourceMonitor, ResourceStats
...
def initialize_runtime_infrastructure() -> None:
    ...
    try:
        ...
        from thegent_infra.resource_limits import get_resource_limits
        from thegent_infra.resource_monitor import get_resource_monitor
