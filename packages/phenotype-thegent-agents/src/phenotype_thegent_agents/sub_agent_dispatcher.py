...
from phenotype_thegent_agents.flash_agent import FlashAgent, FlashAgentConfig
from phenotype_thegent_agents.registry import get_runner

if TYPE_CHECKING:
    from phenotype_thegent_agents.capability_index import AgentRecord, CapabilityIndex
    from phenotype_thegent_core.compute.offload import ComputePoolManager
    from phenotype_thegent_audit.governance.hitl import HITLApprovalWorkflow
...
class SubAgentDispatcher:
    ...
    async def _dispatch_remote(self, task: SubAgentTask) -> SubAgentResult:
        ...
        from phenotype_thegent_core.core.worker_pool import AgentTask
