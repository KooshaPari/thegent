"""Agent runners for thegent - re-exports from phenotype_thegent_agents package."""
...
def __getattr__(name: str) -> Any:
    """Lazy load attributes from phenotype_thegent_agents package."""
    global _agents_module

    if _agents_module is None:
        try:
            import phenotype_thegent_agents as agents
