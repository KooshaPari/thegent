...
from phenotype_thegent_core.infra.power import wrap_with_caffeinate
...
class DirectAgentRunner(AgentRunner):
    ...
    def run(
        ...
        *,
        ...
        from phenotype_thegent_observability.observability.otel_instrumentation import instrument_genai_call
        ...
        with instrument_genai_call(
            ...
            if self._uses_stdin and self.agent_name == "claude" and image_paths:
                from phenotype_thegent_agents.agents.image_inputs import build_claude_stdin_with_images
