...
from phenotype_thegent_agents.agents.registry import get_runner

if TYPE_CHECKING:
    from phenotype_thegent_agents.agents.capability_index import AgentRecord, CapabilityIndex
