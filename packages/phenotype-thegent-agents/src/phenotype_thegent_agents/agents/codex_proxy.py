...
from phenotype_thegent_agents.agents.context_compactor import ContextCompactionResult, ContextCompactor
from phenotype_thegent_agents.agents.cliproxy_manager import ensure_proxy_running
from phenotype_thegent_agents.agents.resilience import TransientAgentError, is_retryable, with_retry
from phenotype_thegent_core.config import ThegentSettings
from phenotype_thegent_agents.discovery import _is_triggered_by_agent_process
from phenotype_thegent_audit.governance.post_agent_run_hook import dispatch_post_agent_run_hook
from phenotype_thegent_core.utils.routing_impl.circuit_breaker import (
    CircuitOpenError,
    ProviderCircuitBreakerRegistry,
    record_deployment_failure,
    record_deployment_success,
)
from phenotype_thegent_core.utils.routing_impl.models import TaskMetadata
from phenotype_thegent_core.utils.routing_impl.provider_types import ExecutionPath, get_execution_path
from phenotype_thegent_core.utils import strip_ansi
...
class CodexProxyRunner(AgentRunner):
    ...
    def run(
        ...
        *,
        ...
        if audio_paths:
            from phenotype_thegent_agents.agents.audio_inputs import inject_transcript_into_prompt, load_transcripts
    ...
    def _run_via_litellm_router(
        ...
        try:
            from phenotype_thegent_core.utils.routing_impl.litellm_router import get_enhanced_router
