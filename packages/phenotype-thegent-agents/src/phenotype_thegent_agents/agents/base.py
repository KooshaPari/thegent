...
if TYPE_CHECKING:
    from phenotype_thegent_agents.agents.sub_agent_dispatcher import SubAgentDispatcher
...
class AgentRunner:
    ...
    def activate_skill(self, name: str) -> str:
        ...
        """
        from phenotype_thegent_skills.skills.discovery import SkillDiscovery
    ...
    def _process_output_deferrals(
        ...
        try:
            from phenotype_thegent_execution.orchestration.resilience.deferral import extract_deferred_tasks
        ...
        try:
            ...
            from phenotype_thegent_execution.orchestration.resilience.deferral import inject_deferred_tasks
