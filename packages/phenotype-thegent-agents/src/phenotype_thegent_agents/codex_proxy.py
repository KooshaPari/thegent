...
from phenotype_thegent_agents.context_compactor import ContextCompactionResult, ContextCompactor
from phenotype_thegent_agents.cliproxy_manager import ensure_proxy_running
from phenotype_thegent_agents.resilience import TransientAgentError, is_retryable, with_retry
...
class CodexProxyRunner(AgentRunner):
    ...
    def run(
        ...
        *,
        ...
        if audio_paths:
            from phenotype_thegent_agents.audio_inputs import inject_transcript_into_prompt, load_transcripts
