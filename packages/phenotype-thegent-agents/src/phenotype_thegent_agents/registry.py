...
from phenotype_thegent_agents.cursor_api_runner import CursorApiRunner
from phenotype_thegent_agents.direct_agents import DirectAgentRunner

if TYPE_CHECKING:
    from phenotype_thegent_agents.teammate_runner import TeammateRunner
...
class AgentRegistry:
    ...
    def get_runner(
        ...
        from phenotype_thegent_agents.teammate_runner import TeammateRunner  # type: ignore[import]
