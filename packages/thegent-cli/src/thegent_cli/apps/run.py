...
def _auto_select_agent(prompt: str) -> str | None:
    ...
    """
    try:
        from thegent_agents.capability_index import CapabilityIndex
...
def run_agent(
    ...
    """
    from thegent_cli.commands.cli import bg_cmd, loop_cmd, run_cmd
...
def run_free(
    ...
    """
    from thegent_cli.commands.cli import bg_cmd, run_cmd
...
def run_history(
    ...
    from thegent_cli.commands.cli import history_cmd
...
def run_logs(
    ...
    from thegent_cli.commands.cli import logs_cmd
...
def run_ps(
    ...
    from thegent_cli.commands.cli import ps_cmd
...
def run_stop(session_id: str | None = typer.Argument(None, help="Session ID to terminate")) -> None:
    from thegent_cli.commands.cli import loop_stop_cmd, stop_cmd
...
def run_fork(
    ...
    from thegent_cli.commands.cli import session_fork_cmd
...
def run_rollback(
    ...
    from thegent_cli.commands.cli import session_rollback_cmd
