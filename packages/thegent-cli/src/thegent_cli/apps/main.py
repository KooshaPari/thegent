...
try:
    ...
    if missing_name not in {"thegent_git", "thegent_cli.commands.cli_git"} and "thegent-git" not in str(exc):
        raise
...
def quick_do(prompt: str = typer.Argument(..., help="Prompt to execute")):
    from thegent_cli.apps.run import run_agent
...
def review_cmd(
    ...
    # @trace WL-107
    from thegent_cli.commands.cli import _format_context_usage_line
    from thegent_cli.commands.impl import review_impl
...
def resume_top_level(
    ...
    from thegent_cli.commands.cli import resume_cmd
...
def fork_top_level(
    ...
    from thegent_cli.apps.run import run_fork
...
def rollback_top_level(
    ...
    from thegent_cli.apps.run import run_rollback
...
def quick_ps(
    ...
    from thegent_cli.apps.run import run_ps
...
def list_agents_cmd_wrapper() -> None:
    from thegent_cli.commands.model_cmds import list_agents_cmd
...
def list_droids_cmd_wrapper(
    ...
    from thegent_cli.commands.model_cmds import list_droids_cmd
...
def session_health_gate_wrapper(
    ...
    from thegent_cli.commands.session_cmds import session_contract_health_gate_cmd
...
def session_health_report_wrapper(
    ...
    from thegent_cli.commands.session_cmds import session_contract_health_report_cmd
...
def session_health_trend_wrapper(
    ...
    from thegent_cli.commands.session_cmds import session_contract_health_trend_cmd
...
def domain_map_compat(
    ...
    from thegent_cli.commands.domain_map import domain_map_cmd
...
def help_cmd(
    ...
    Example::
        ...
        thegent help doctor
    """
    from thegent_cli.help_examples import show_help_examples
