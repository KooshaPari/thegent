"""Command implementations for project tenancy CLI.

Split from project.py for maintainability. All command functions and helpers
are defined here; the typer app objects are imported from project.py.
...
from thegent_cli.apps.project import (
    console,
    install_app,
    install_project_app,
    scaffold_app,
...
def install_callback(
    ...
    if setup:
        from thegent_cli.commands.model_cmds import setup_cmd
