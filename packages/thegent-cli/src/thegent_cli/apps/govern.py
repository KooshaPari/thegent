...
def govern_vet(
    ...
    from thegent_cli.services.governance import govern_vet_impl
...
def govern_register_host(
    ...
    from thegent_cli.commands.impl import harness_register_host_impl
...
def govern_negotiate(
    ...
    from thegent_cli.commands.session_control_impl import session_contract_negotiate_impl
