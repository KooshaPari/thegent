...
from thegent_cli.commands.plan_output_helpers import (
    render_dag_list,
    render_dag_ready,
    render_dag_status,
...
def plan_incorporate_cmd(cd: Path | None = None, dry_run: bool = False) -> None:
    ...
    from thegent_cli.commands.work_stream_impl import incorporate_impl
...
def plan_wait_next_cmd(
    ...
    from thegent_cli.commands.work_stream_impl import wait_next_impl
...
def plan_do_next_cmd(cd: Path | None = None, limit: int = 5, format: str | None = None) -> None:
    ...
    from thegent_cli.commands.work_stream_impl import do_next_impl
...
def plan_analyze_cmd(
    ...
    from thegent_cli.commands.impl import plan_analyze_impl
