...
from thegent_cli.commands.infra_env_helpers import resolve_env_file, rewrite_max_concurrency_lines
from thegent_cli.commands.infra_interruption_helpers import load_recent_interruptions
from thegent_cli.commands.infra_observe_helpers import build_observe_lines
from thegent_cli.commands.infra_sitback_helpers import build_dashboard_panels
from thegent_cli.commands.infra_usage_helpers import build_provider_usage_table
...
def usage_cmd(format: str | None = None, include_cost: bool = True) -> None:
    ...
    """
    settings = ThegentSettings()
    from thegent_agents.cliproxy_manager import fetch_provider_metrics
...
def purge_cmd(dry_run: bool = True) -> None:
    ...
    from thegent_cli.commands.impl import purge_impl
...
def observe_summary_cmd(
    ...
    from thegent_cli.commands.impl import observe_summary_impl
...
def sitback_dashboard_cmd(
    ...
    """
    from thegent_cli.commands.impl import sitback_dashboard_impl
...
def operations_cmd(
    ...
    from thegent_cli.commands.operations_commands import operations_cmd as _operations_cmd_impl
...
def forensics_snapshot_cmd(run_id: str | None = None, phase: str | None = None) -> None:
    ...
    from thegent_cli.commands.recovery_commands import forensics_snapshot_cmd as _forensics_snapshot_cmd_impl
...
def monitor_cmd(interval: float = 2.0) -> None:
    ...
    from thegent_cli.commands.impl import monitor_impl
