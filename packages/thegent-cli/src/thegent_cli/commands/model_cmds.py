...
from thegent_cli.commands.model_cmds_agents_helpers import render_agents_table, render_droids_table
from thegent_cli.commands.model_cmds_catalog_helpers import (
    emit_by_model_view,
    emit_contract_view,
    provider_sequence,
    run_provider_listings,
)
from thegent_cli.commands.model_cmds_metrics_helpers import (
    build_index_data,
...
from thegent_cli.commands.model_cmds_route_helpers import build_available_routes, build_resolved_route
from thegent_cli.commands.model_cmds_setup_helpers import (
    build_provider_list,
    configure_providers,
    set_env_line,
)
...
def setup_cmd(
    ...
    from thegent_agents.cliproxy_manager import (
        _LOGIN_FLAGS,
    ...
    if should_delegate_setup:
        from thegent_agents.cliproxy_manager import _binary_available, _resolve_binary
    ...
    try:
        from thegent_agents.cliproxy_manager import _ensure_config
...
def rules_sync_cmd(
    ...
    from thegent_cli.commands.impl import rules_sync_impl
