...
from thegent_cli.commands.output import health_export_writers
from thegent_cli.commands.output import health_serializers as health_output
...
def _format_context_usage_line(context_usage: object) -> str | None:
    ...
    if isinstance(used, int) and isinstance(max_val, int):
        from thegent_cli.services.run_input_helpers import build_context_usage_payload
