...
from thegent_cli.commands._cli_shared import _resolve_checkpoint_id
from thegent_cli.services.run_session_helpers import (
...
def dag_status_cmd(cd: Path | None = None, format: str | None = None) -> None:
    ...
    from thegent_cli.commands.dag_impl import dag_status_impl
