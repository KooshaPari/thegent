...
def monitor_impl(interval: float = 2.0) -> None:
    ...
    from thegent_cli.commands.impl import do_next_impl, ps_impl as _ps_impl
...
def orchestrate_plan_impl(
    ...
    *,
    ...
    from thegent_agents.plangent import LLMPlangentPlanner
...
def orchestrate_run_impl(
    ...
    *,
    ...
    from thegent_agents.plangent import LLMPlangentPlanner, PlangentExecutor
