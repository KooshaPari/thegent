...
from thegent_cli.commands.governance_health_helpers import (
...
def data_protection_cmd(format: str | None = None) -> None:
    ...
    from thegent_cli.commands.impl import get_data_protection_status_impl
...
def compliance_report_cmd(
    ...
    from thegent_cli.commands.impl import get_compliance_report_impl
...
def escalate_add_cmd(
    ...
    from thegent_cli.commands.impl import escalate_add_impl
...
def sweep_cmd(
    ...
    from thegent_cli.commands.impl import sweep_impl
...
def escalate_resolve_cmd(run_id: str | None = None, resolution: str = "resolved") -> None:
    ...
    from thegent_cli.commands.impl import escalate_resolve_impl
...
def escalate_approve_cmd(run_id: str | None = None) -> None:
    ...
    rid = _resolve_run_id(run_id)
    from thegent_cli.commands.impl import escalate_approve_impl
...
def govern_reject_cmd(run_id: str, reason: str | None = None) -> None:
    ...
    """
    from thegent_cli.commands.impl import govern_reject_impl
