...
def _impl_settings():
    from thegent_cli.commands import impl as cli_impl
...
def wait_impl(session_id: str, timeout: int | None = None) -> dict[str, Any]:
    ...
    """
    from thegent_cli.commands.impl import _is_pid_running, _session_paths, time
...
def stop_impl(session_id: str, force: bool = False) -> dict[str, Any]:
    ...
    """
    from thegent_cli.commands.impl import _is_pid_running
...
def metrics_impl() -> dict[str, Any]:
    ...
    from thegent_cli.commands.session_ops_impl import ps_impl
...
def prune_sessions_impl(days: int | None = None) -> dict[str, Any]:
    ...
    from thegent_cli.commands.impl import _is_pid_running, _session_paths
