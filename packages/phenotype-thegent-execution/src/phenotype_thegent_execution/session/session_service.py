...
from phenotype_thegent_execution.session.zmx_backend import SessionBackend, ZmxBackend, resolve_session_backend
...
def get_session_service() -> SessionService:
    ...
    DI container (phenotype_thegent_core.container.global_container).
    """
