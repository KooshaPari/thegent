...
class ConcurrencyController:
    ...
    def __init__(
        ...
        if use_load_based:
            try:
                from phenotype_thegent_execution.orchestration.resource.resource_management import (
                    BottleneckDetector,
    ...
    def acquire(
        ...
        if self.use_load_based and (True):  # Default to True
            ...
            try:
                from phenotype_thegent_execution.orchestration.resource.resource_management import sample_extended_resources
            ...
            if admitted:
                ...
                if soft_deadline_s is not None and soft_deadline_s > 0:
                    from phenotype_thegent_execution.orchestration.resource.load_based_limits import get_deadline_monitor
