# test_cache API Reference

> **Source**: `src/thegent/memory/test_cache.py`
...
```python
test_clear_both_layers(self: Any)
```
...
```python
test_set_stores_both_layers(self: Any)
```
...
```python
test_l1_sub_millisecond(self: Any)
```
