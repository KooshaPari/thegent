...
## 1. Objective
To provide a high-fidelity relationship map of agent actions, codebase evolution, and system state. This enables "long-term memory" for agents to understand *who* changed *what*, *why*, and *how* different tasks are interconnected.
