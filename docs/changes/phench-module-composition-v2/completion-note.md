...
- Added `scan-shared-repos` schema/candidate contract, sibling worktree scanning mode, strict exclude validation, and shared-module materialization workflow examples.
...
- P29-P44 and P46-P47: complete in current implementation and docs updates.
