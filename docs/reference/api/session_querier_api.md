# session_querier API Reference

> **Source**: `src/thegent/ports/driven/session_querier.py`
...
#### SessionQuerier.find_session_meta

```python
find_session_meta(self: Any, settings: ThegentSettings, session_id: str)
```
...
#### SessionQuerier.list_sessions

```python
list_sessions(self: Any, owner: Any, all: bool, agent: Any, status: Any, limit: int, scan_ide: bool, include_contract: bool)
```
...
**Returns**: List of session dictionaries with id, status, etc.
