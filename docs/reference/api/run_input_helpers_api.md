# run_input_helpers API Reference

> **Source**: `src/thegent/cli/services/run_input_helpers.py`
...
```python
append_context_usage(payload: dict[(str, Any)], result: RunResult)
```
...
```python
model_supports_vision(model: str)
```
...
```python
normalize_image_paths(image_paths: Any)
```
