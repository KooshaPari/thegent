# tools_dynamic_registry API Reference

> **Source**: `src/thegent/mcp/server/tools_dynamic_registry.py`
...
## register_dynamic_registry_tools
...
**Returns**: (thegent_register_tool, thegent_complete_tool_call, thegent_list_dynamic_tools)
