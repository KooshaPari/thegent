// Auto-generated usage examples for git
// Source: generate-api-docs.py

import { GitParallelismManager, create_commit_from_index, ensure_index, get_agent_status, stage_files, update_ref_cas } from "./git";

// Create a GitParallelismManager instance
const gitparallelismmanager = new GitParallelismManager("example_project_root", "example_agent_id", "example_mesh_root");
