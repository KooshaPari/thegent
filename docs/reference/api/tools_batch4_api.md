# tools_batch4 API Reference

> **Source**: `src/thegent/mcp/server/tools_batch4.py`

Batch 4 MCP tool registrations extracted from server.py.

---

## register_batch4_tools
...
```python
thegent_activate_skill(skill_name: str)
```
...
```python
thegent_macos_run_script(script: str, language: Literal[(applescript, jxa)])
```
