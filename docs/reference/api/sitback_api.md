# sitback API Reference

> **Source**: `src/thegent/mcp/tools/sitback.py`
...
```python
resource_sitback_dashboard(profile: str)
```
...
```python
thegent_sitback_dashboard(profile: str)
```
...
```python
thegent_sitback_spawn_sibling(agent: str)
```
