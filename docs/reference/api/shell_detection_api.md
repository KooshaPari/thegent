# shell_detection API Reference

> **Source**: `src/thegent/infra/shell_detection.py`
...
## get_fast_command_prefix

```python
get_fast_command_prefix(shell_type: ShellType)
```
...
```python
get_preferred_shell(performance: bool)
```
...
```python
get_shell_executable(shell_type: ShellType)
```
