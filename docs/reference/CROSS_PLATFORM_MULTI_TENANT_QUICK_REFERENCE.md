...
```bash
# Run agent with sub-user isolation (default)
thegent run "Task" agent-name

# Run agent with OS user isolation (requires admin/root)
thegent run --isolation-mode osuser "Task" agent-name
