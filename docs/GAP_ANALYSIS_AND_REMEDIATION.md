...
1. Implement Phase 2 Cursor block in CLIProxyAPIPlus-fork.
...
| G-RV-08 | **WBS-X8: Migration and Rollout** | Done | `docs/contracts/UPGRADE_PLAYBOOK.md`; dual-read/dual-write, canary stages, rollback; THGENT_CONTRACT_CANARY_*. |
...
## 10. FastMCP Research Docs (FASTMCP_*)
...
| ID | Item | Reason |
|----|------|--------|
| G-CP-01/02/03 | CLIProxy Phase 2 Cursor block, Phase 1 patch | External: CLIProxyAPIPlus-fork |
