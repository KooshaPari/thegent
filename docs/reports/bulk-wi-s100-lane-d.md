...
**Source:** [thegent/src/thegent/queue/storage.go:270]
...
**Source:** [thegent/src/thegent/runner/runner.go:299]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
**Source:** [thegent/src/thegent/policy/engine.go:328]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
**Source:** [thegent/src/thegent/observability/prometheus.go:357]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
**Source:** [thegent/src/thegent/mcp/server.go:386]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
### [WL-10655]
**Title:** Preserve policy gating by separating matching and enforcement paths
**Source:** [thegent/src/thegent/commands/dispatch.go:415]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
### [WL-10656]
**Title:** Preserve observability by separating events from serialization
**Source:** [thegent/src/thegent/integrations/gh_project_sync.py:444]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
### [WL-10657]
**Title:** Preserve workflow progression by separating guard checks and execution
**Source:** [thegent/src/thegent/hooks/dispatcher.go:473]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
...
### [WL-10658]
**Title:** Preserve session consistency by separating state updates and persistence
**Source:** [thegent/src/thegent/session/state.go:502]
**Acceptance checklist:
- [ ] Separate parse and execution paths.
- [ ] Preserve current behavior on both happy and failure paths.
- [ ] Add regression tests around boundary conditions.
