...
### [WL-7599]
**Title:** Distinguish plain-text REST responses from malformed JSON decode failures
**Source:** [thegent/src/thegent/mcp/rest_to_mcp.py:126]
**Acceptance checklist:**
- [ ] Replace broad response parse suppression with explicit JSON-decode and text-fallback branches.
...
**Notes:** Line 126 currently obscures whether payloads are non-JSON by design or syntactically invalid.
