...
**Date**: 2026-02-23
**Scope**: Complete enumeration of all known projects, repositories, packages, and content
...
- **HuggingFace**: https://huggingface.co/ruv
- **Websites**: https://ruv.io, https://ruv.net, https://agentics.ruv.io
- **Organization**: Agentics Foundation (agentics.org)
...
- **Role**: Harvard CS50 Teaching Fellow, AGI Researcher
- **Company**: Yes2 AI (Chief AI Solution & Data Architect)
...
### 2.5 Courses Designed

Brad Ross has designed **5 courses** on leveraging AI:

1. AI-First Methodology
2. Pattern Recognition over Domain Expertise
3. Rapid Learning Systems
4. Identifying Unsolved Problems
5. AI Collaboration Skills

---

## 3. RELATED PROJECTS & ORGANIZATIONS
...
4. **SPARC** - 5-phase TDD methodology
5. **Multi-Model Router** - 27+ models, 85-99% cost reduction
...
4. **Strict Rules Creativity** - 98% meaning preservation with varied expression
