...
| 2026-03-24 | **Billing-bound CI** | **`FULL_TURN_DELIVERY.md`**: section *Billing / Actions quota* — when jobs do not start; **`gh pr merge --admin`** only after infra confirmation + local verification; **`05_KNOWN_ISSUES.md`** updated. |
