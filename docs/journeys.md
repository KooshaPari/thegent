...
This document contains E2E user journey demonstrations for `thegent`.
...
<div class="gif-demo">
  <img src="./public/assets/demos/cli-demo.gif" alt="CLI installation demo">
...
<div class="gif-demo">
  <img src="./public/assets/demos/cli-demo.gif" alt="Provider configuration demo">
