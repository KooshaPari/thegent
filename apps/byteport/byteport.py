...
def _discover_pheno_sdk_path() -> Optional[Path]:
...
try:
    from kinfra.orchestrator import OrchestratorConfig
    from kinfra.service_manager import ServiceConfig
    from kinfra.orchestration import (
        GoServiceOptions,
...
def get_byteport_services(
    *,
    ...
    frontend_dir = root_dir / "frontend" / "web-next"
