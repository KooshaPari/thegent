...
func deployEC2(AccessKey string, SecretKey string, BucketName string, service models.Service) ([]EC2InstanceInfo,error){
	...
	buildScript := generateBuildScript(bucket, service, {creds.AccessKeyID, creds.SecretAccessKey})
...
func buildEC2Service(bucket S3DeploymentInfo, service models.Service, creds models.AwsCreds, ) (string,error){
	// genScript
