...
func provisionNetwork(AccessKey string, SecretKey string, projectName string, tgArn string) (string, string, error) {
...
func awaitInitialization(AccessKey string, SecretKey string, instanceId string) (error){
