...
func provisionNetwork(AccessKey string, SecretKey string, projetctName string) (string, error) {
	...
	c.createHostedZone(context.Background(), projectName+"-Byteport", "us-east-1", "vpc-123456")
