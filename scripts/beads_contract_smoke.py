#!/usr/bin/env python3
"""Fail-fast beads integration contract smoke check.
...
def main() -> int:
    base_url = _require_env("BEADS_BASE_URL").rstrip("/")
    ...
    try:
        ...
        raise RuntimeError(f"beads health check failed: {exc}") from exc
