...
class TestMemorySharingService(unittest.TestCase):
    ...
    def test_store_and_get_learnings(self):
        ...
        self.assertEqual(results[0]["content"]["skill"], "navigation")
    ...
    def test_get_learnings_min_importance(self):
        ...
        results = self.service.get_agent_learnings("agent_a", min_importance=0.5)
        self.assertEqual(len(results), 1)
        self.assertEqual(results[0]["memory_id"], "mem2")
    ...
    def test_record_learning_transfer_basic(self):
        ...
        self.assertEqual(history[0]["source_agent_id"], "agent_a")
        self.assertEqual(history[0]["target_agent_id"], "agent_b")
    ...
    def test_get_transfer_history_as_source(self):
        ...
        self.assertEqual(target_agents, {"agent_b", "agent_c"})
    ...
    def test_get_transfer_history_as_target(self):
        ...
        self.assertEqual(source_agents, {"agent_a", "agent_c"})
    ...
    def test_get_most_shared_learnings(self):
        ...
        self.assertEqual(results[0]["memory_id"], "mem1")
        self.assertEqual(results[0]["transfer_count"], 3)
        self.assertEqual(results[1]["memory_id"], "mem2")
        self.assertEqual(results[1]["transfer_count"], 1)
