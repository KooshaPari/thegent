...
def swarm_usage(
    session_dir: str | None = typer.Option(
        None, "--session-dir", "-d", help="Session directory (default: cwd)"
    ),
    owner: str | None = typer.Option(
        None, "--owner", "-o", help="Filter to a specific owner"
    ),
    ...
    if owner is not None:
        ...
        from thegent.orchestration.load_based_limits import OwnerStats
