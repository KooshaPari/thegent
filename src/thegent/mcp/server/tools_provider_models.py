...
def register_provider_model_tools(*, mcp: FastMCP) -> tuple[
    ...
    def list_providers(include_credentials: bool = False) -> str:
        ...
        return json.dumps(_list_providers(include_credentials=include_credentials), indent=2)
    ...
    def list_credentials() -> str:
        ...
        return json.dumps(_list_credentials(), indent=2)
    ...
    def discover_models(provider: str | None = None) -> str:
        ...
        return json.dumps(_discover_models(provider), indent=2)
    ...
    def list_models(provider: str | None = None) -> str:
        ...
        return json.dumps(_list_models(provider), indent=2)
