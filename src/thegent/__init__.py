...
# Python version requirements: CPython 3.10+ or PyPy 3.11+
if sys.implementation.name == "cpython" and sys.version_info < (3, 10):
    raise RuntimeError("thegent requires CPython 3.10+. Please upgrade Python.")
if sys.implementation.name == "pypy" and sys.version_info < (3, 11):
    raise RuntimeError("thegent requires PyPy 3.11+. Please upgrade PyPy.")
