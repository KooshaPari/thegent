...
from thegent.contracts.registry import ContractVersion, get_registry
...
class MigrationController:
    ...
    def evaluate_version(self, contract_id: str, version: str) -> dict[str, Any]:
        ...
        if cv.deprecated:
            ...
            return {"allowed": True, "status": "deprecated", "reason": f"Contract {contract_id}@{version} is deprecated."}
