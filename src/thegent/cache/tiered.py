...
class TieredCache:
    ...
    def __init__(
        self, l1_ttl: float = 60.0, l2_ttl: float = 3600.0, l1_max_size: int = 1000, l2_cache_dir: str = ".cache/l2"
    ):
    ...
    def get_or_set(
        self, key: str, factory: Callable[[], Any], l1_ttl: Optional[float] = None, l2_ttl: Optional[float] = None
    ) -> Any:
