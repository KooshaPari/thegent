...
"""
    ...
    def generate_batch(self, md_files: list[Path]) -> list[Path]:
        ...
        for md_file in md_files:
            self._generate_single_llm_output(generated, md_file)

        return generated

    def _generate_single_llm_output(self, generated: list[Path], md_file: Path) -> None:
        """Generate LLM output for a single markdown file safely."""
        try:
