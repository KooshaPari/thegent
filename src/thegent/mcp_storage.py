...
def _storage_base() -> Path:
    """Return resolved base directory, honouring THGENT_MCP_STORAGE_DIR env var."""
    import os

    raw = os.environ.get("THGENT_MCP_STORAGE_DIR")
    if raw:
...
def _reset_singletons_for_testing(
    ...
    """Replace singletons with test instances.  **For tests only.**"""
