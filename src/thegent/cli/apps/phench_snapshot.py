...
def register_snapshot_commands(
    ...
    def snapshot_create_cmd(
        ...
        result = create_target_snapshot_fn(target, snapshot_id=snapshot_id)
    ...
    def snapshot_list_cmd(target: str = typer.Argument(..., help="Target name.")) -> None:
        snapshots = list_target_snapshots_fn(target)
    ...
    def snapshot_show_cmd(
        ...
        payload = show_target_snapshot_fn(target, snapshot_id)
