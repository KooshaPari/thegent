"""Thegent CLI swarm commands — backwards-compat wrapper for extracted team subpackage.
...
from thegent.cli.commands.team.cli_swarm import *  # noqa: F401, F403 -- WL-125 re-export
