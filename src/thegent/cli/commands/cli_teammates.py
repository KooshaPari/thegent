"""Thegent CLI teammates commands — backwards-compat wrapper for extracted team subpackage.
...
from thegent.cli.commands.team.cli_teammates import *  # noqa: F401, F403 -- WL-125 re-export
