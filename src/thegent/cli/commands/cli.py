...
def concurrency_show_cmd(format: str | None = None) -> None:
    ...
    from thegent.cli.commands.impl import ps_impl
    from thegent.orchestration.load_based_limits import LimitGateConfig, compute_dynamic_limit, sample_resources
...
def retry_cmd(
    ...
    from thegent.cli.commands.impl import history_impl, retry_impl
...
def plan_complete_cmd(item_id: str, agent_id: str | None = None, cd: Path | None = None) -> None:
    ...
    from thegent.cli.commands.impl import work_stream_complete_impl
    from thegent.discovery import get_current_agent_id
...
def plan_wait_next_cmd(
    ...
    from thegent.cli.commands.impl import wait_next_impl
