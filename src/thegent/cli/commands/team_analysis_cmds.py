"""Thegent CLI team analysis commands — backwards-compat wrapper for extracted team subpackage.
...
from thegent.cli.commands.team.team_analysis_cmds import *  # noqa: F401, F403 -- WL-125 re-export
