...
from thegent.cli.commands.observability.observability_main_impl import (
    observe_summary_impl,
)

# Re-export escalation and governance functions
from thegent.cli.commands.observability.observability_escalation_impl import (
...
from thegent.cli.commands.observability.observability_governance_impl import (
...
from thegent.cli.commands.observability.observability_health_impl import (
...
from thegent.cli.commands.observability.observability_trends_impl import (
