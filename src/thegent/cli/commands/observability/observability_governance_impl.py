...
def get_server_meta_impl() -> dict[str, Any]:
    ...
    from thegent.cli.commands.observability.observability_health_impl import (  # pyright: ignore[reportMissingImports]
        HEALTH_PAYLOAD_SCHEMA_VERSION,
        HEALTH_PAYLOAD_TYPES,
    )
    from thegent.cli.commands.observability.observability_trends_impl import (  # pyright: ignore[reportMissingImports]
        OBSERVE_SUMMARY_PAYLOAD_TYPES,
        OBSERVE_SUMMARY_SCHEMA_VERSION,
    )

    from thegent.cli.commands.observability.observability_health_impl import HEALTH_POLICY_PROFILES
