...
from thegent.cli.commands.observability.infra_observe_helpers import build_observe_lines
from thegent.cli.commands.observability.infra_sitback_helpers import build_dashboard_panels
...
def observe_summary_cmd(
    ...
    from thegent.cli.commands.observability.observability_main_impl import observe_summary_impl  # pyright: ignore[reportMissingImports]
