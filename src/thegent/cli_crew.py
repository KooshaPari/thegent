...
from thegent.crew import Crew, CrewAgent, ExecutionMode, Task
...
def crew_execute_cmd(
    ...
    """Execute a crew."""
    console.print(f"[yellow]Executing crew {crew_id}...[/yellow]")
    console.print("[red]Error: Crew execution requires crew persistence. Not yet implemented.[/red]")
    console.print("[dim]Use Python API directly for now.[/dim]")
    raise typer.Exit(1)
