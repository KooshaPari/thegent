...
class TestAutopilotStatusCommand:
    ...
    def test_autopilot_status_no_file(self):
        ...
        result = runner.invoke(app, ["sync", "autopilot-status", "--format", "rich"])
    ...
    def test_autopilot_status_json_output(self):
        ...
        result = runner.invoke(app, ["sync", "autopilot-status", "--format", "json"])
    ...
    @pytest.mark.requirement("WL-171")
    def test_autopilot_status_with_valid_status_file(self, tmp_path):
    ...
    @pytest.mark.requirement("WL-171")
    def test_autopilot_status_with_degraded_health(self, tmp_path):
    ...
    @pytest.mark.requirement("WL-171")
    def test_autopilot_status_with_down_health(self, tmp_path):
    ...
    @pytest.mark.requirement("WL-171")
    def test_autopilot_status_with_malformed_json(self, tmp_path):
