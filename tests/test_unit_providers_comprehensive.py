...
class TestDirectAgentRunnerComprehensive:
    ...
    def test_run_basic(self, mock_run, agent, project_root):
    ...
    @patch("thegent.agents.direct_agents.subprocess.run")
    def test_cursor_workspace_arg(self, mock_run, project_root):
        mock_run.return_value = MagicMock(returncode=0, stdout="ok", stderr="")
    ...
    @patch("thegent.agents.direct_agents.subprocess.run")
    def test_claude_stream_arg(self, mock_run, project_root):
        mock_run.return_value = MagicMock(returncode=0, stdout="ok", stderr="")
    ...
    @patch("thegent.agents.direct_agents.subprocess.run")
    def test_mode_mapping(self, mock_run, project_root):
        mock_run.return_value = MagicMock(returncode=0, stdout="ok", stderr="")
    ...
    @patch("thegent.agents.direct_agents.subprocess.run")
    def test_timeout_handling(self, mock_run, project_root):
    ...
    @patch("thegent.agents.direct_agents.subprocess.run")
    def test_retry_on_transient_error(self, mock_run, project_root):
    ...
    def test_run_live(self, mock_popen, project_root):
        mock_proc = MagicMock()
...
class TestCodexProxyRunnerComprehensive:
    ...
    def test_proxy_agents_basic(self, mock_run, mock_ensure, agent, project_root):
    ...
    @patch("thegent.agents.codex_proxy.ensure_proxy_running")
    @patch("thegent.agents.codex_proxy.subprocess.run")
    def test_mode_mapping(self, mock_run, mock_ensure, project_root):
        mock_ensure.return_value = "http://localhost:8317"
        mock_run.return_value = MagicMock(returncode=0, stdout="ok", stderr="")
...
class TestCursorApiRunnerComprehensive:
    ...
    def test_cursor_api_basic(self, mock_run, mock_reachable, project_root):
    ...
    @patch("thegent.agents.cursor_api_runner._is_cursor_api_reachable")
    def test_cursor_api_unreachable(self, mock_reachable, project_root):
    ...
    @patch("thegent.agents.cursor_api_runner._is_cursor_api_reachable")
    @patch("thegent.agents.cursor_api_runner.subprocess.run")
    def test_mode_mapping(self, mock_run, mock_reachable, project_root):
        mock_reachable.return_value = True
        mock_run.return_value = MagicMock(returncode=0, stdout="ok", stderr="")
