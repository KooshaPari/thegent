...
**Important**: The constitution is OPTIONAL. All agileplus commands work without it.
...
- **A (Skip)**: Create a minimal placeholder at `.kittify/memory/constitution.md`:
  - Title + short note: "Constitution skipped - not required for agileplus usage. Run /agileplus.constitution anytime to create one."
  - Exit successfully.
...
> Auto-generated by agileplus constitution command
> Created: [YYYY-MM-DD]
> Version: 1.0.0
...
- Next steps (review, share with team, run /agileplus.specify)
