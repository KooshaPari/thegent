...
**Inputs**: Design documents from `/agileplus/[###-feature-name]/`
...
**Prompt Files**: Each work package references a matching prompt file in `/tasks/` generated by `/agileplus.tasks`. Treat this file as the high-level checklist; keep deep implementation detail inside the prompt files.
